...
- We enabled usage of relative or absolute paths depending on whether the user has toggled memoryStickMode on or off. [#3590](https://github.com/JabRef/jabref/issues/3590)
