...
- We fixed an issue where the AI chat jumped to the bottom when switching back to an entry; the previous scroll position is now restored. [#17172](https://github.com/JabRef/jabref/pull/17172)
