...
- We added a feature that allows the user to customize the Springer API Key in the customization tab of the preferences and check this key [#6877](https://github.com/JabRef/jabref/issues/6877)
