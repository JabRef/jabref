...
- We fixed the non-functionality of the option "Automatically sync bibliography when inserting citations" when enabled in case of JStyles. [#11684](https://github.com/JabRef/jabref/issues/11684)
