...
- We fixed an issue where after a Fulltext search the user needed to manually switch an entry to display the "Search results" tab. [#12865](https://github.com/JabRef/jabref/issues/12865)
