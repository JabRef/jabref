...
- We no longer close the document viewer when pressing Escape, so a stray key press does not discard the opened PDF. [#17175](https://github.com/JabRef/jabref/pull/17175)
