...
- We merged the functionality "Append contents from a BibTeX library into the currently viewed library" into the "Import into database" functionality [#6184](https://github.com/JabRef/jabref/pull/6184).
