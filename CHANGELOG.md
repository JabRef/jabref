...
- We fixed an issue where empty entries in a shared PostgreSQL database would become invisible "ghost" entries and break the UI interface. [#15658](https://github.com/JabRef/jabref/issues/15658)
