...
- We fixed an issue where opening a child entry linked to a parent PDF via `crossref` did not navigate to the correct page. [#8128](https://github.com/JabRef/jabref/issues/8128)
