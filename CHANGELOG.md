...
- We fixed an issue where libraries would sometimes be hidden when closing tabs with the Welcome page open. [#12894](https://github.com/JabRef/jabref/issues/12894)
