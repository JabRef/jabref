...
- We fixed an issue where importing several files at once created one undo entry per file instead of one for the whole import, and undoing more than once afterwards failed. [#16613](https://github.com/JabRef/jabref/pull/XXXXX)
- We fixed an issue where changes made in the "Manage keywords" dialog could not be undone. [#XXXXX](https://github.com/JabRef/jabref/pull/XXXXX)
