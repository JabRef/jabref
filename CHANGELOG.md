...
### Changed
- [#970](https://github.com/JabRef/jabref/issues/970): Implementation of shared database support (base system) with event based synchronization for MySQL, PostgreSQL and Oracle database systems.
