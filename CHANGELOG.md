...
- We added support for "Search Semantic Scholar" to quickly search for a selected entry's title in Semantic Scholar directly from the main table's context menu
