...
- We moved Pandoc path setting into Preferences under OpenOffice/LibreOffice to improve the user experience. The BST style shows the configured Pandoc path state. [#16352](https://github.com/JabRef/jabref/issues/16352)
