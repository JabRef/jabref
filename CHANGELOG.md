...
- The PDF merge dialog (shown when importing a single PDF) now includes a "From DOI" column with bibliographic data fetched from the DOI detected in the PDF. [#15415](https://github.com/JabRef/jabref/issues/15415)
