...
- When dragging and dropping several PDF files into the main table, the menu icon for background tasks becomes a progress indicator visualising the import's progress. [#12035](https://github.com/JabRef/jabref/pull/12035)
