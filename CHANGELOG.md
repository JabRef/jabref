...
- We fixed an issue where the integrity check wrongly reported person names as not being in the standard format when the field value was wrapped over multiple lines. [JabRef/jabref-issue-melting-pot#1319](https://github.com/JabRef/jabref-issue-melting-pot/issues/1319)
