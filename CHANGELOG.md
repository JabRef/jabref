...
- We added the ability to automatically select and focus the newly imported entry in the Entry Editor when double-clicking a non-local entry in the Citation Relations tab. [#15460](https://github.com/JabRef/jabref/issues/15460)
