...
- Parsing citations with an LLM in the "New Entry" dialog runs in the background, so the dialog closes immediately. [#17158](https://github.com/JabRef/jabref/pull/17158)
