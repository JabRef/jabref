...
- We fixed an issue where a library file that could not be read opened as an empty, untitled library without any error message. [#17028](https://github.com/JabRef/jabref/pull/17028)
