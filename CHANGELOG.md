...
- Undoing or redoing now says what was taken back ("Undone: Generate citation keys") instead of only "Undo". [#16857](https://github.com/JabRef/jabref/pull/16857)
...
- We fixed an issue where undoing while a background operation (import, merge, citation key generation, identifier lookup, auto-linking files) was still writing to the library could produce a state that undo could not describe. Undo and redo now decline until the operation has finished. [#16857](https://github.com/JabRef/jabref/pull/16857)
- Undoing or redoing a step that could only be applied in part now says so instead of failing silently. [#16857](https://github.com/JabRef/jabref/pull/16857)
