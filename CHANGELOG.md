...
- We added Tools > New library based on references in PDF file... to create a new library based on the references section in a PDF file. 
- When converting the references section of a paper (PDF file), more than the last page is treated.
