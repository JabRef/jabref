...
- We added [unpaywall](https://unpaywall.org/) as fulltext fetcher. [#todo](https://github.com/JabRef/jabref/pull/todo)
- We added the possibility to configure the email provided to unpaywall. [#todo](https://github.com/JabRef/jabref/pull/todo)
