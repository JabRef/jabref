...
- We changed the `jabkit` binary distribution to ship an ahead-of-time (AOT) cache, improving startup time. [#947](https://github.com/JabRef/jabref-issue-melting-pot/issues/947)
