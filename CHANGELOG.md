...
- The entry editor restores the cursor position in each field when returning to a previously edited entry (kept for the running session; not persisted). [TODO](TODO)
