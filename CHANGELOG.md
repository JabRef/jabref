...
- The "Connect to shared database" dialog now fills itself from a pasted connection URL and hides rarely needed settings. [#16800](https://github.com/JabRef/jabref/pull/16800)
...
- We changed [remote SQL database](https://docs.jabref.org/collaborative-work/sqldatabase) synchronization to PostgreSQL-only with live updates; changes made while the connection is down are kept and synchronized once it is back; existing database tables are migrated. [#11232](https://github.com/JabRef/jabref/issues/11232) [#11211](https://github.com/JabRef/jabref/issues/11211)
