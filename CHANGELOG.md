...
- We resolved the UI issue that occurred when displaying the number of entries in a group exceeding four digits by converting them to numerical abbreviations. [#8797](https://github.com/JabRef/jabref/issues/8797)
