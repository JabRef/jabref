...
- We fixed an issue about JabRef not looking for attached files to bib entries in the bib directory, if not set as primary. [#6863](https://github.com/JabRef/jabref/issues/6863)
