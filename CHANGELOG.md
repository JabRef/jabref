...
- We fixed an issue where the "Convert to BibTeX-Cleanup" moved the content of the `file` field to the `pdf` field [#4210](https://github.com/JabRef/jabref/issues/4120)
