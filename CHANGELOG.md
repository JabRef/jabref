...
- We fixe an issue where the right-click action "Copy cite..." did not respect the configured citation command under "External Programs" -> "Push Appplications" [#10615](https://github.com/JabRef/jabref/issues/10615)
