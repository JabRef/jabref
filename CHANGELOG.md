...
- We fixed `DateFormatter`. It was generating localized month names instead of English names when the system locale was not English. [#16224](https://github.com/JabRef/jabref/issues/16224)
