...
- We fixed an issue where an AI chat connection error showed only "java.net.ConnectException" instead of the server URL and the reason. [#17125](https://github.com/JabRef/jabref/pull/17125)
