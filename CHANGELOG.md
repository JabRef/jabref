...
- The "Automatically open folders of attached files" preference default status has been changed to enabled.[koppor#56](https://github.com/koppor/jabref/issues/56)
