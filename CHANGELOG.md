...
- We fixed saving libraries so hard links remain intact and libraries can be saved when atomic moves are not supported. [#7718](https://github.com/JabRef/jabref/issues/7718)
