...
- We improved Quality > Automatically set file links so that if a file is moved, it is automatically relinked. [#9798](https://github.com/JabRef/jabref/issues/9798)
