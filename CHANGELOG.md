...
- We fixed an issue where the Linux (deb, rpm) and Windows (msi) packages did not register JabRef as the application for `.bib` files. [#17006](https://github.com/JabRef/jabref/issues/17006)
