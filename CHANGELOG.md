...
- We fixed `jabkit pdf update --format=xmp` silently succeeding without writing XMP metadata to the linked PDF. [#16087](https://github.com/JabRef/jabref/issues/16087)
