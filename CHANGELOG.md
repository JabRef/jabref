...
- We removed the default custom entry editor tabs "General", "Abstract", "Comments", and "Review" (including those stored by JabRef 3.x–5.x); their content is part of the new "Main" tab. User-defined custom tabs are kept. [#12711](https://github.com/JabRef/jabref/issues/12711)
