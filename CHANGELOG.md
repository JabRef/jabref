...
- We fixed an issue where importing a reference from a PDF URL failed to extract metadata when no file directory was set. [#16306](https://github.com/JabRef/jabref/issues/16306)
