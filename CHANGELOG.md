...
- We fixed an issue where writing metadata to a PDF rewrote the file in place, so file synchronization tools (e.g. Syncthing, Dropbox) could pick up a half-written, corrupted PDF. The PDF is now replaced atomically. [#16782](https://github.com/JabRef/jabref/pull/16782)
