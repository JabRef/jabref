...
- We changed the donation prompt to appear as a notification in the notification center instead of a separate popup on the Welcome tab. [#TODO](https://github.com/JabRef/jabref/pull/TODO)
