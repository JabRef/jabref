...
- We fixed an issue where the "Backup found" dialog appeared while another library tab was on top when several libraries were opened at once. [#16919](https://github.com/JabRef/jabref/pull/16919)
