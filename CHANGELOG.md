...
- We added an option to include currently selected entries when creating a new explicit group, and newly created groups are now selected automatically. TODO
