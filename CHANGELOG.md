...
- We improved the startup time of the `jabkit` binary distribution by shipping an ahead-of-time (AOT) cache. [#947](https://github.com/JabRef/jabref-issue-melting-pot/issues/947)
