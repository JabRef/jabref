...
- Fixed an issue where the sidepane failed to remember its custom width and reset to the default size upon restarting the application. [#8907](https://github.com/JabRef/jabref/issues/8907)
