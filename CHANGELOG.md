...
- The entry editor restores the cursor position in each field when returning to a previously edited entry (kept for the running session; not persisted). [#16375](https://github.com/JabRef/jabref/pull/16375)
