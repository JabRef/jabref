...
- We fixed an issue where the ISIDORE fetcher failed with an SSL handshake error because a missing root certificate and a bug in `URLDownload` silently bypassed JabRef's custom trust store for every fetcher. [#16054](https://github.com/JabRef/jabref/issues/16054)
