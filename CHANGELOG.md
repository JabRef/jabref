...
- We fixed an issue where the AI chat tab kept saying "Unable to chat" after a file was attached to the entry, e.g. by dropping a PDF into the entry editor. [#17157](https://github.com/JabRef/jabref/pull/17157)
