...
- We fixed an issue where entries imported in the background could not be selected or updated in the main table. [#TODO](https://github.com/JabRef/jabref/pull/TODO)
