...
- We fixed an issue where case-sensitive search (`=!`, `==!`, `=~!`) in linked files ignored the case and matched every spelling. [#13048](https://github.com/JabRef/jabref/issues/13048)
