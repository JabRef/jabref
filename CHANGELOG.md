...
- The AI summary tab now renders Markdown directly as JavaFX nodes instead of converting it to HTML and displaying it in a `WebView`, matching how AI chat messages are rendered. [#TODO](https://github.com/JabRef/jabref/pull/TODO)
