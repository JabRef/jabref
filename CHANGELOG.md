...
- We added a preference to skip the import dialog for entries received from browser extensions, allowing direct import into the current library (new default).
