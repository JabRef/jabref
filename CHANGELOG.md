...
- We now render the entry preview with regular JavaFX components instead of an embedded browser. Text in the preview can be selected with the mouse and copied; without a selection, "Copy selection" copies the whole preview. [#16145](https://github.com/JabRef/jabref/pull/16145)
