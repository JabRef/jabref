...
- We fixed an issue where critical errors during JabRef startup were not shown to the user. Now an error dialog is displayed before the application crashes. [#14967](https://github.com/JabRef/jabref/issues/14967)
