...
- We added a button "Add classic tabs" to the entry editor preferences, which adds the tabs "General" and "Abstract" known from JabRef 5. [#16669](https://github.com/JabRef/jabref/pull/16669)
