...
- we fixed an issue where closing the last open library left an empty tab area instead of showing the Welcome tab. [#16451](https://github.com/JabRef/jabref/issues/16451)
