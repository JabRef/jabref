...
- We fixed an issue where file synchronization tools (e.g. Syncthing, Dropbox) could pick up a half-written PDF while JabRef wrote metadata. [#16782](https://github.com/JabRef/jabref/pull/16782)
