...
- SSL connections to a shared database now trust the certificates from Preferences → Network; the keystore fields and the database type selection of the login dialog were removed. [#16800](https://github.com/JabRef/jabref/pull/16800)
