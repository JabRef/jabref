...
- We fixed an issue with endless exception dialogues appearing if the file path includes an illegal char. [#7381](https://github.com/JabRef/jabref/issues/7381)
