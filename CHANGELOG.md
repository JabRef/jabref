...
- We added a per-library keyword separator to the library properties, so opening a library no longer rewrites keyword fields. [JabRef/jabref-issue-melting-pot#1353](https://github.com/JabRef/jabref-issue-melting-pot/issues/1353)
