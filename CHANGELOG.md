...
- We fixed an issue where the preferences for "Linked files" ignored the setting "search and store files relative to library file location" when the main file directory setting was non-empty [#8385](https://github.com/JabRef/jabref/issues/8385)
