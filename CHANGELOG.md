...
- We added a warning when opening a library from JabRef before 3.4 whose static group memberships would be lost on save. [#3251](https://github.com/JabRef/jabref/issues/3251)
