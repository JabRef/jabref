...
- We fixed an issue where a backup differing from the library only in modification dates was offered for restoring. [JabRef/jabref-issue-melting-pot#1252](https://github.com/JabRef/jabref-issue-melting-pot/issues/1252)
