...
- We fixed the search box `styleProperty` replacing the hardcoded color with PseudoClasses. [#15721](https://github.com/JabRef/jabref/issues/15721), also the search box text was invisible with `JabRef - Light theme` - fixed as a side effect. 
