...
- We added a "What's new" toolbar button for JabRef run from a checkout, listing changelog entries not yet seen. [#17104](https://github.com/JabRef/jabref/pull/17104)
