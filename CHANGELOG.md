...
- We added "Contribute to JabRef" to the Help menu, linking to [contribute.jabref.org](https://contribute.jabref.org). [#PRNUM](https://github.com/JabRef/jabref/pull/PRNUM)
...
- We fixed an issue where "Community forum" in the Help menu opened the donation page instead of the forum. [#PRNUM](https://github.com/JabRef/jabref/pull/PRNUM)
