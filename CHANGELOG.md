...
- We fixed an issue where saving a library, writing a backup, or writing PDF metadata dropped the file's group, hidden/read-only flags, ACL and extended attributes (e.g. macOS Finder tags). [koppor#750](https://github.com/JabRef/jabref-koppor/issues/750)
