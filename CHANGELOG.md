...
- git add jablb/src/test/java/org/jabref/model/entry/DateTest.javaAdded support for BibLaTeX date ranges and improved normalization in the date editor. [#14289](https://github.com/JabRef/jabref/pull/14289)
