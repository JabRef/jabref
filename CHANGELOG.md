...
### Fixed
- We Fixed an issue where last opened files were saved as absolute paths in Memory Stick Mode, hindering portability [#3590](https://github.com/JabRef/jabref/issues/3590)
