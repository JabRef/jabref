...
- We fixed an issue where the "Entrytype" column header in the main table (and other internal field names) was shown in lower case. [#16894](https://github.com/JabRef/jabref/pull/16894)
