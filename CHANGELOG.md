...
- We fixed an issue where searching for special characters (e.g. `*`, `{`, `[`) would crash the preview with an uncaught regex exception instead of just highlighting the results. [#16539](https://github.com/JabRef/jabref/issues/16539)
