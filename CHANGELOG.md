...
- We fixed an issue where AI chat history was being shared between groups with the same name in different libraries. [#14641](https://github.com/JabRef/jabref/issues/14641)
