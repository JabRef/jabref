...
- We fixed an issue in the entry editor's "Main" tab where the Keywords and Groups fields were given a fixed height instead of sizing to their content, leaving excess blank space below a short list of chips and clipping a long, wrapped one. [#12112](https://github.com/JabRef/jabref/issues/12112)
