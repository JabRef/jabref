...
- We added web search capability to ScienceDirect using the Scopus Search API, enabling users to search for academic literature directly from JabRef. [#14421](https://github.com/JabRef/jabref/issues/14421)
