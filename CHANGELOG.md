...
- We renamed the sort dropdown default option in "Search for unlinked local files" from "default" to "Grouped by directory". [#16158](https://github.com/JabRef/jabref/issues/16158)
