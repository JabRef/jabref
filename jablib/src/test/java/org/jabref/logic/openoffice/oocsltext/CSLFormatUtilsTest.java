...
class CSLFormatUtilsTest {
    ...
    ///
    /// @implSpec Assumes that [generateBibliography][CitationStyleGenerator#generateBibliography(List, String, CitationStyleOutputFormat, BibDatabaseContext, BibEntryTypesManager)] works as expected.
    ...
    ///
    /// @implSpec Assumes that [generateCitation][CitationStyleGenerator#generateCitation(List, String, CitationStyleOutputFormat, BibDatabaseContext, BibEntryTypesManager)] works as expected.
    @ParameterizedTest(name = "{index} => {1}")
    @MethodSource
    ...
    ///
    /// @implSpec Assumes that the method [authorsAlpha][org.jabref.logic.citationkeypattern.BracketedPattern#authorsAlpha] works as expected.
    @ParameterizedTest
    @MethodSource
