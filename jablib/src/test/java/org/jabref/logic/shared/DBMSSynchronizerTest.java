...
class DBMSSynchronizerTest {
    ...
    void setup() throws SQLException, InvalidDBMSConnectionPropertiesException, DatabaseNotSupportedException {
        ...
        dbmsSynchronizer = new DBMSSynchronizer(context, ',', fieldPreferences, mock(FilePreferences.class), mock(TimestampPreferences.class), mock(AbbreviationPreferences.class), pattern, new DummyFileUpdateMonitor(), "UserAndHost", mock(JournalAbbreviationRepository.class));
