...
class DateTest {
    ...
    void normalizedRangeIsCorrect() {
        ...
        assertEquals("2020-01-01/2020-02-01", date.getNormalized());
    }

    @Test
    void normalizedSingleDateIsCorrect() {
        Date date = new Date(LocalDate.of(2020, 1, 1));

        assertEquals("2020-01-01", date.getNormalized());
    }
    ...
    void endDatePresentForRange() {
        ...
        assertTrue(date.getEndDate().isPresent());
    }
    ...
    void endDateEmptyForSingleDate() {
        ...
        assertTrue(date.getEndDate().isEmpty());
    }
}
