...
/// A [LocaleProvider] that loads locales from a directory in the current module.
///
/// This implementation is only a slight adaption of [de.undercouch.citeproc.DefaultLocaleProvider].
