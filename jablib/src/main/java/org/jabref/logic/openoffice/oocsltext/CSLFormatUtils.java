...
public final class CSLFormatUtils {
    ...
    /// Context: The HTML produced by {@link org.jabref.logic.citationstyle.CitationStyleGenerator#generateBibliography(List, String, org.jabref.logic.citationstyle.CitationStyleOutputFormat, BibDatabaseContext, org.jabref.model.entry.BibEntryTypesManager) generateBibliography} or {@link org.jabref.logic.citationstyle.CitationStyleGenerator#generateCitation(List, String, org.jabref.logic.citationstyle.CitationStyleOutputFormat, BibDatabaseContext, org.jabref.model.entry.BibEntryTypesManager) generateCitation} is not directly (completely) parsable by {@link org.jabref.model.openoffice.ootext.OOTextIntoOO#write(com.sun.star.text.XTextDocument, com.sun.star.text.XTextCursor, org.jabref.model.openoffice.ootext.OOText) write}.
    /// For more details, read the documentation for the {@link org.jabref.model.openoffice.ootext.OOTextIntoOO} class.
