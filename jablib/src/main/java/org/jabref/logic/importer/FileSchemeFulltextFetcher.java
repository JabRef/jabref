...
/// Marker interface for [FulltextFetcher]s that are trusted to return local `file:` URLs.
///
...
///
/// [FulltextFetchers] rejects any `file:` URL returned by a fetcher that does not implement
/// this interface.
@NullMarked
