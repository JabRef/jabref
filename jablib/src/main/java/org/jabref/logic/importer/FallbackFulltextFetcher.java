...
/// Marker interface for [FulltextFetcher]s that are consulted only as a fallback, after the
...
/// fetcher already yields a PDF, so [FulltextFetchers] defers it until the direct fetchers
/// come up empty.
@NullMarked
