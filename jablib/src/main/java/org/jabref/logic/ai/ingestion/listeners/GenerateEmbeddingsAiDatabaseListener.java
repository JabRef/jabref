...
public class GenerateEmbeddingsAiDatabaseListener implements AiDatabaseListener {
    ...
    private class EntriesChangedListener {
        ...
        public void listen(EntriesAddedEvent e) {
            if (!aiPreferences.getAiFeaturesEnabledCurrently() || !aiPreferences.getAutoGenerateEmbeddings()) {
                return;
            }
        ...
        public void listen(FieldChangedEvent e) {
            if (!aiPreferences.getAiFeaturesEnabledCurrently() || !aiPreferences.getAutoGenerateEmbeddings() || e.getField() != StandardField.FILE) {
                return;
            }
