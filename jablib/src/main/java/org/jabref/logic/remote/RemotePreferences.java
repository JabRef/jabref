...
public class RemotePreferences {
    ...
    public RemotePreferences(int port, boolean useRemoteServer, int httpPort, boolean enableHttpServer, boolean enableLanguageServer, int languageServerPort, List<String> allowedOrigins, String apiToken, boolean directHttpImport, boolean allowUnauthenticatedAccessWithoutOrigin) {
