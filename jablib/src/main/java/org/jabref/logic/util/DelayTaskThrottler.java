...
///
/// @implNote Once [#schedule(Runnable)] is called, the task is delayed for a given time span.
/// If during this time, [#schedule(Runnable)] is called again, then the original task is canceled and the new one scheduled.
