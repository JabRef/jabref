...
public class MetadataSerializationConfiguration {
    ...
    /// Identifier for [org.jabref.model.groups.WordKeywordGroup] and [org.jabref.model.groups.RegexKeywordGroup].
    public static final String KEYWORD_GROUP_ID = "KeywordGroup:";

    /// Identifier for [org.jabref.model.groups.AllEntriesGroup].
    public static final String ALL_ENTRIES_GROUP_ID = "AllEntriesGroup:";

    /// Old identifier for [org.jabref.model.groups.ExplicitGroup] (explicitly contained a list of [org.jabref.model.entry.BibEntry]).
    public static final String LEGACY_EXPLICIT_GROUP_ID = "ExplicitGroup:";

    /// Identifier for [org.jabref.model.groups.ExplicitGroup].
    public static final String EXPLICIT_GROUP_ID = "StaticGroup:";

    /// Identifier for [org.jabref.model.groups.SearchGroup].
    public static final String SEARCH_GROUP_ID = "SearchGroup:";

    /// Identifier for [org.jabref.model.groups.AutomaticPersonsGroup].
    public static final String AUTOMATIC_PERSONS_GROUP_ID = "AutomaticPersonsGroup:";

    /// Identifier for [org.jabref.model.groups.AutomaticKeywordGroup].
    public static final String AUTOMATIC_KEYWORD_GROUP_ID = "AutomaticKeywordGroup:";

    /// Identifier for [org.jabref.model.groups.AutomaticEntryTypeGroup].
    public static final String AUTOMATIC_ENTRY_TYPE_GROUP_ID = "AutomaticEntryTypeGroup:";

    /// Identifier for [org.jabref.model.groups.TexGroup].
