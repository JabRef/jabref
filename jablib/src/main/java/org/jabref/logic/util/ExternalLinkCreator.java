...
public class ExternalLinkCreator {
     ...
     */
    private Optional<String> buildSearchUrl(String baseUrl, String defaultUrl, String title, 
                                           Optional<String> author, String serviceName) {
        ...
        if (!isValidHttpUrl(baseUrl)) {
            ...
            return buildUrlWithQueryParams(defaultUrl, title, author, serviceName);
        }
     ...
     */
    private Optional<String> buildUrlWithQueryParams(String baseUrl, String title, 
                                                     Optional<String> author, String serviceName) {
        try {
