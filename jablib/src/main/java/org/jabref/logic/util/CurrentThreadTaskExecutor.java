...
/// Implementation of [TaskExecutor] that runs every task on the current thread, i.e. in a sequential order. This
...
public class CurrentThreadTaskExecutor implements TaskExecutor {
    ...
    /// Executes the task on the current thread. The code is essentially taken from [javafx.concurrent.Task.TaskCallable#call()], but adapted to run sequentially.
    @Override
