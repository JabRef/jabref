...
<xsl:stylesheet
    ...
    <xsl:template
        ...
        <xsl:choose>
            ...
            <xsl:when
                    test="$over='&#x0FE37;'">    <!-- OverBrace - over brace -->
                <xsl:text>
                    \overbrace{
                </xsl:text>
                <xsl:call-template
            ...
            <xsl:when
                    test="$under='&#x00332;'">    <!-- UnderBar - combining low line -->
                <xsl:text>
                    \underline{
                </xsl:text>
                <xsl:call-template
            ...
            <xsl:when
                    test="$under='&#x0FE38;'">    <!-- UnderBrace - under brace -->
                <xsl:text>
                    \underbrace{
                </xsl:text>
                <xsl:call-template
    ...
    <xsl:template
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:text>
                    \underset{
                </xsl:text>        <!-- Required AmsMath package -->
                <xsl:apply-templates
                        select="./*[2]"/>
                <xsl:text>
                    }{
    ...
    <xsl:template
            match="m:mmultiscripts"
            mode="mprescripts">
        <xsl:for-each
                select="m:mprescripts/following-sibling::*">
        ...
        <xsl:apply-templates
                select="./*[1]"/>
        <xsl:for-each
                select="m:mprescripts/preceding-sibling::*[position()!=last()]">
