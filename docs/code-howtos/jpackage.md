...
JabRef
uses [jpackage](https://docs.oracle.com/en/java/javase/25/jpackage/)
to
build
binary
application
...
we
use
the [Java Module Packaging Gradle plugin](https://github.com/gradlex-org/java-module-packaging).
...
Modify
the
`build\packages\windows-latest\JabRef\runtime\bin\Jabref.bat`
file,
replace
the
last
