...
1. Go to a test case (example: [`org.jabref.model.entry.BibEntryTest#settingTypeToNullThrowsException`](https://github.com/JabRef/jabref/blob/main/jablib/src/test/java/org/jabref/model/entry/BibEntryTest.java#L52-L52)
