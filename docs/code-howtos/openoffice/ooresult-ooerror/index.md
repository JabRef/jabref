...
Jonatan
Asketorp
in [this thread](https://github.com/koppor/jabref/pull/496#discussion_r629695493), "
most
of
them (
all?)
...
to
`(!entries.isEmpty() && checkThatEntriesHaveKeys(entries))`
...
here" ...
using
a [Result type](https://en.wikipedia.org/wiki/Result_type)
as
a
return
value
...
>
`class X<R,E> { boolean isOK; Object data; }`
expresses
this
assumption
more
...
`OOResult<Void,E>`\
According
to [baeldung.com/java-void-type](https://www.baeldung.com/java-void-type),
the
only
possible
value
