...
| [arXiv](https://info.arxiv.org/help/api/index.html)                                                                                               | (none)                                                                                                         | (none)                         | [One request per three seconds](https://info.arxiv.org/help/api/tou.html)             |
| [DOAJ](https://doaj.org/)                                                                                                                         | (none)                                                                                                         | (none)                         | [2 requests/second](https://doaj.org/api/docs)                                        |
