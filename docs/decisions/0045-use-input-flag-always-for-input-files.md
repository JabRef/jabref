# Use
`--input` Flag Consistently for Reading Input Files
...
code
review
discussion: [GitHub Discussion](https://github.com/JabRef/jabref/pull/13158#discussion_r2106254233).
...
### Adopt a consistent syntax (
`--input`) for reading input files across all subcommands
