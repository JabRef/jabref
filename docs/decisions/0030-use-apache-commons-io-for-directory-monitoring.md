...
automatically
update
the [LaTeX Citations](https://docs.jabref.org/advanced/entryeditor/latex-citations)
when
a
LaTeX
file
...
file
system
structure ([#10930](https://github.com/JabRef/jabref/issues/10930)).
...
because:
    ...
    folder (
    JDK
    issue: [JDK-8162948](https://bugs.openjdk.org/browse/JDK-8162948)).
    2.
    Deleting
    a
    subdirectory
    ...
    Windows (
    JDK
    issue: [JDK-6972833](https://bugs.openjdk.org/browse/JDK-6972833)).
    4.
    Implemented
    on
    macOS
    ...
    `PollingWatchService`. (
    JDK
    issue: [JDK-8293067](https://bugs.openjdk.org/browse/JDK-8293067))
