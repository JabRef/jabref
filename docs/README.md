...
development,
follow
the [Jekyll installation instructions](https://jekyllrb.com/docs/installation/).
Installing
the
latest
version
...
is
hand-crafted.
The [Jekyll Docker image](https://github.com/envygeeks/jekyll-docker#jekyll-docker)
did
not
work
end
...
That
command
uses [act](https://github.com/nektos/act),
which
brings
GitHub
actions
