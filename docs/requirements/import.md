...
When importing BibTeX entries, JabRef interprets the configured accepted keyword delimiters and stores the resulting keywords using the library's keyword separator.
