...
## Privileged workflows must protect outputs and commands from untrusted PR content
...
## Issue linking workflow must preserve existing issue assignment when external PR is opened
