...
An answer that is a JSON document, on its own or inside a fenced code block, is shown as a monospaced code block with syntax highlighting instead of flowed text.
