...
## Changes in
`jablib/src/main/resources/csl-styles` are shown
...
is
contained
in [Step 1: Get the code into IntelliJ](intellij-11-code-into-ide.md).
...
`Files.copy`
at
`org.jabref.logic.journals.JournalAbbreviationLoader.loadRepository(JournalAbbreviationLoader.java:30) ~[classes/:?]`,
invalidate
caches
and
restart
...
that
your [xdg-desktop-portal](https://wiki.archlinux.org/title/XDG_Desktop_Portal)
settings
refer
to
active
...
discussion
at
issue [#11766](https://github.com/JabRef/jabref/issues/11766).
