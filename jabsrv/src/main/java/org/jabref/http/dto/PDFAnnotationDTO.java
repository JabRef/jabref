...
public class PDFAnnotationDTO {
    ...
    private LinkedPdfFileDTO parentPDFFile; // contains: title, path and parent BibEntry
    ...
    /// @return a PDFAnnotationDTO
    public PDFAnnotationDTO(Path pathToParentPDFFile, BibEntry parentBibEntry, FileAnnotation annotation) {
