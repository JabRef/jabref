...
dependencies.constraints {
    ...
    api("dev.langchain4j:langchain4j-google-ai-gemini:1.1.0-beta6")
    api("dev.langchain4j:langchain4j-hugging-face:1.1.0-beta6")
    api("dev.langchain4j:langchain4j-mistral-ai:1.1.0-beta6")
