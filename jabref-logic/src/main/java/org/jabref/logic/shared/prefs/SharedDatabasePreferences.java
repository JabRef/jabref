...
public class SharedDatabasePreferences {
    ...
    private static final String PARENT_NODE = "org.jabref-shared";
    ...
    public SharedDatabasePreferences(String sharedDatabaseID) {
        internalPrefs = Preferences.userRoot().node(PARENT_NODE).node(sharedDatabaseID);
    }
    ...
    public static void clearAll() throws BackingStoreException {
        Preferences.userRoot().node(PARENT_NODE).clear();
    }
