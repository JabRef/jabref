...
class CommentsTabTest {
    ...
    void setUp() {
        ...
        when(entryEditorPreferences.isStaticTabVisible(EntryEditorTabModel.StaticTab.USER_COMMENTS)).thenReturn(true);
    ...
    void emptyCommentFieldNotShownIfGloballyDisabled() {
        when(entryEditorPreferences.isStaticTabVisible(EntryEditorTabModel.StaticTab.USER_COMMENTS)).thenReturn(false);
    ...
    void commentFieldShownIfContainsText(boolean shouldShowUserCommentsFields) {
        final UserSpecificCommentField ownerComment = new UserSpecificCommentField(ownerName);
        when(entryEditorPreferences.isStaticTabVisible(EntryEditorTabModel.StaticTab.USER_COMMENTS)).thenReturn(shouldShowUserCommentsFields);
