...
public class EditorTextField extends TextField implements Initializable, ContextMenuAddable {
    ...
    /**
     * Sets up the tab navigation callbacks for all EditorTextField instances.
     * This should be called once during initialization by the EntryEditor.
     *
     * @param isLastFieldChecker Function to check if a TextField is the last field in the current tab
     * @param nextTabSelector Action to select the next tab
     */
