...
public class IconTheme {
    ...
    public enum JabRefIcons implements JabRefIcon {
        ...
        DELETE_ENTRY(SvgPaths.DELETE_ENTRY),
        ...
        LEFT(SvgPaths.ARROW_LEFT),
        RIGHT(SvgPaths.ARROW_RIGHT),
        SOURCE(MaterialDesignC.CODE_BRACES),
        MAKE_KEY(SvgPaths.MAKE_KEY),
        CLEANUP_ENTRIES(SvgPaths.CLEANUP),
        ...
        ADD_ENTRY_IMMEDIATE(SvgPaths.ADD_ENTRY_IMMEDIATE),
