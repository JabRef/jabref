...
public enum StandardActions implements Action {
    ...
    MERGE_WITH_FETCHED_ENTRY(Localization.lang("Update with bibliographic information via identifier(s)"), IconTheme.JabRefIcons.WWW),
    UPDATE_WITH_WEB_INFO(Localization.lang("Update with bibliographic information from the web via entry data"), IconTheme.JabRefIcons.WWW),
