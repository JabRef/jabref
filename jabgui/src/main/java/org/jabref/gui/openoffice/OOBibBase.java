...
public class OOBibBase {
    ...
    public void guiActionInsertEntry(List<BibEntry> entries,
        ...
        try {
            ...
            if (style instanceof CitationStyle citationStyle) {
                // Handle insertion of CSL citations
    ...
    /// Helper method for guiActionInsertEntry(), tests Dialog states before attempting to insert citation group
    ...
    /// Helper method for guiActionInsertEntry(), handles the insertion of CSL style citations
    ...
    /// Helper method for guiActionInsertEntry(), handles the insertion of JStyle style citations
    ...
    /// Helper function for guiActionUpdateDocument, creates a CSL bibliography.
    ///
    /// @param databases Must have at least one.
    private void createCSLBibliography(List<BibDatabase> databases, CitationStyle citationStyle, XTextDocument doc, OOResult<FunctionalTextViewCursor, OOError> fcursor) throws WrappedTargetException, CreationException {
        try {
    ...
    /// Helper function for guiActionUpdateDocument, refreshes the bibliography.
    ///
    /// @param databases Must have at least one.
