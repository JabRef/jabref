...
public class WalkthroughAction extends SimpleCommand {
    ...
    private static Map<String, Walkthrough> buildRegistry() {
        ...
        TooltipStep step1 = TooltipStep.builder("Hover over \"File\" menu")
        ...
        TooltipStep step2 = TooltipStep.builder("Select \"Preferences\"")
        ...
        TooltipStep step3 = TooltipStep.builder("Select \"Linked files\" tab")
        ...
        TooltipStep step4 = TooltipStep.builder("Choose to use main file directory")
        ...
        Walkthrough mainFileDirectory = new Walkthrough(List.of(step1, step2, step3, step4));
