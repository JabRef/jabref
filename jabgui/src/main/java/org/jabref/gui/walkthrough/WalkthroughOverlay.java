...
public class WalkthroughOverlay {
    ...
    private void revertAllSideEffects() {
        ...
        // Revert in reverse order of step execution
        List<Integer> stepIndices = new java.util.ArrayList<>(executedSideEffects.keySet());
        stepIndices.sort((a, b) -> Integer.compare(b, a)); // Reverse order
