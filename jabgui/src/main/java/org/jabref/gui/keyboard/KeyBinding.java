...
public enum KeyBinding {
    ...
    CLOSE_DATABASE("Close library", Localization.lang("Close library"), "shortcut+W", KeyBindingCategory.FILE),
    CLOSE("Close dialog", Localization.lang("Close dialog"), "Esc", KeyBindingCategory.VIEW),
    COPY("Copy", Localization.lang("Copy"), "shortcut+C", KeyBindingCategory.EDIT),
    COPY_TITLE("Copy title", Localization.lang("Copy title"), "shortcut+shift+alt+T", KeyBindingCategory.EDIT),
    JUMP_TO_FIELD("Jump to field", Localization.lang("Jump to field"), "shortcut+J", KeyBindingCategory.EDIT),
    ...
    COPY_CITE_CITATION_KEY("Copy \\cite{citation key}", Localization.lang("Copy citation key with configured cite command"), "shortcut+K", KeyBindingCategory.EDIT),

    COPY_CITATION_KEY("Copy citation key", Localization.lang("Copy citation key"), "shortcut+shift+K", KeyBindingCategory.EDIT),
    COPY_CITATION_KEY_AND_TITLE("Copy citation key and title", Localization.lang("Copy citation key and title"), "shortcut+shift+alt+K", KeyBindingCategory.EDIT),
    COPY_CITATION_KEY_AND_LINK("Copy citation key and link", Localization.lang("Copy citation key and link"), "shortcut+alt+K", KeyBindingCategory.EDIT),
    COPY_PREVIEW("Copy preview", Localization.lang("Copy preview"), "shortcut+shift+C", KeyBindingCategory.VIEW),
    CUT("Cut", Localization.lang("Cut"), "shortcut+X", KeyBindingCategory.EDIT),
    ...
    EXPORT("Export", Localization.lang("Export"), "shortcut+alt+e", KeyBindingCategory.FILE),
    EXPORT_SELECTED("Export Selected", Localization.lang("Export selected entries"), "shortcut+shift+e", KeyBindingCategory.FILE),
    EDIT_STRINGS("Edit strings", Localization.lang("Edit strings"), "shortcut+T", KeyBindingCategory.BIBTEX),
    ...
    ENTRY_EDITOR_NEXT_PANEL("Entry editor, next panel", Localization.lang("Entry editor, next panel"), "shortcut+TAB", KeyBindingCategory.VIEW),
    ENTRY_EDITOR_NEXT_PANEL_2("Entry editor, next panel 2", Localization.lang("Entry editor, next panel 2"), "shortcut+PLUS", KeyBindingCategory.VIEW),
    ...
    ENTRY_EDITOR_PREVIOUS_PANEL("Entry editor, previous panel", Localization.lang("Entry editor, previous panel"), "shortcut+shift+TAB", KeyBindingCategory.VIEW),
    FILE_LIST_EDITOR_MOVE_ENTRY_DOWN("File list editor, move entry down", Localization.lang("File list editor, move entry down"), "shortcut+DOWN", KeyBindingCategory.VIEW),
    ...
    IMPORT_INTO_CURRENT_DATABASE("Import into current library", Localization.lang("Import into current library"), "shortcut+I", KeyBindingCategory.FILE),
    IMPORT_INTO_NEW_DATABASE("Import into new library", Localization.lang("Import into new library"), "shortcut+alt+I", KeyBindingCategory.FILE),
    MERGE_ENTRIES("Merge entries", Localization.lang("Merge entries"), "shortcut+M", KeyBindingCategory.TOOLS),
    ...
    ADD_ENTRY("Add entry", Localization.lang("Add entry"), "shortcut+N", KeyBindingCategory.BIBTEX),
    ADD_ENTRY_IDENTIFIER("Enter identifier", Localization.lang("Enter identifier"), "shortcut+alt+shift+N", KeyBindingCategory.BIBTEX),
    ADD_ENTRY_PLAINTEXT("Interpret citations", Localization.lang("Interpret citations"), "shortcut+shift+N", KeyBindingCategory.BIBTEX),
    NEW_ARTICLE("New article", Localization.lang("New article"), "shortcut+shift+A", KeyBindingCategory.BIBTEX),
    NEW_BOOK("New book", Localization.lang("New book"), "shortcut+shift+B", KeyBindingCategory.BIBTEX),
    NEW_INBOOK("New inbook", Localization.lang("New inbook"), "shortcut+shift+I", KeyBindingCategory.BIBTEX),
    NEW_MASTERSTHESIS("New mastersthesis", Localization.lang("New mastersthesis"), "shortcut+shift+M", KeyBindingCategory.BIBTEX),
    NEW_PHDTHESIS("New phdthesis", Localization.lang("New phdthesis"), "shortcut+shift+T", KeyBindingCategory.BIBTEX),
    NEW_PROCEEDINGS("New proceedings", Localization.lang("New proceedings"), "shortcut+shift+P", KeyBindingCategory.BIBTEX),
    NEW_UNPUBLISHED("New unpublished", Localization.lang("New unpublished"), "shortcut+shift+U", KeyBindingCategory.BIBTEX),
    ...
    NEXT_LIBRARY("Next library", Localization.lang("Next library"), "shortcut+PAGE_DOWN", KeyBindingCategory.VIEW),
    OPEN_CONSOLE("Open terminal here", Localization.lang("Open terminal here"), "shortcut+shift+L", KeyBindingCategory.TOOLS),
    OPEN_DATABASE("Open library", Localization.lang("Open library"), "shortcut+O", KeyBindingCategory.FILE),
    OPEN_FILE("Open file", Localization.lang("Open file"), "F4", KeyBindingCategory.TOOLS),
    OPEN_FOLDER("Open folder", Localization.lang("Open folder"), "shortcut+shift+O", KeyBindingCategory.TOOLS),
    ...
    SHOW_PREFS("Preferences", Localization.lang("Preferences"), "shortcut+,", KeyBindingCategory.FILE),
    OPEN_URL_OR_DOI("Open URL or DOI", Localization.lang("Open URL or DOI"), "F3", KeyBindingCategory.TOOLS),
    PASTE("Paste", Localization.lang("Paste"), "shortcut+V", KeyBindingCategory.EDIT),
    PULL_CHANGES_FROM_SHARED_DATABASE("Pull changes from shared database", Localization.lang("Pull changes from shared database"), "shortcut+shift+R", KeyBindingCategory.FILE),
    ...
    REFRESH_OO("Refresh OO", Localization.lang("Refresh OpenOffice/LibreOffice"), "shortcut+alt+O", KeyBindingCategory.TOOLS),
    REPLACE_STRING("Replace string", Localization.lang("Replace string"), "shortcut+R", KeyBindingCategory.SEARCH),
    RESOLVE_DUPLICATE_CITATION_KEYS("Resolve duplicate citation keys", Localization.lang("Resolve duplicate citation keys"), "shortcut+shift+D", KeyBindingCategory.BIBTEX),
    SAVE_ALL("Save all", Localization.lang("Save all"), "shortcut+alt+S", KeyBindingCategory.FILE),
    SAVE_DATABASE("Save library", Localization.lang("Save library"), "shortcut+S", KeyBindingCategory.FILE),
    SAVE_DATABASE_AS("Save library as ...", Localization.lang("Save library as..."), "shortcut+shift+S", KeyBindingCategory.FILE),
    SEARCH("Search", Localization.lang("Search"), "shortcut+F", KeyBindingCategory.SEARCH),
    OPEN_GLOBAL_SEARCH_DIALOG("Open global search window", Localization.lang("Open global search window"), "shortcut+shift+F", KeyBindingCategory.SEARCH),
    SELECT_ALL("Select all", Localization.lang("Select all"), "shortcut+A", KeyBindingCategory.EDIT),
    ...
    STRING_DIALOG_ADD_STRING("String dialog, add string", Localization.lang("String dialog, add string"), "shortcut+N", KeyBindingCategory.FILE),
