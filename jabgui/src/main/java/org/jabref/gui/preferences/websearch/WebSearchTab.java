...
public class WebSearchTab extends AbstractPreferenceTabView<WebSearchTabViewModel> implements PreferencesTab {
    ...
    @FXML private CheckBox abbreviateJournalOnDownload;
    ...
    public void initialize() {
        ...
        abbreviateJournalOnDownload.selectedProperty().bindBidirectional(viewModel.abbreviateJournalOnDownloadProperty());
