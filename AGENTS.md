...
please
read
our [AI policy](./CONTRIBUTING.md#ai-usage-policy).
...
human
to
use [JabRef on DeepWiki](https://deepwiki.com/JabRef/jabref).
...
as
documented
in [docs/getting-into-the-code/guidelines-for-setting-up-a-local-workspace/intellij-13-code-style.md](docs/getting-into-the-code/guidelines-for-setting-up-a-local-workspace/intellij-13-code-style.md)
-
Follow
the
principles
...
Thread()\",
use
\"org.jabref.logic.util.BackgroundTask\"
and
its
\"executeWith\"
-
...
be
used,
the [JSpecify](https://jspecify.dev/)
annotations
must
be
used.
...
More
information
at: <https://devdocs.jabref.org/code-howtos/localization.html>.
