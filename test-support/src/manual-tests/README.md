...
## [issue-13689: Refine "Find unlinked files" dialog](https://github.com/JabRef/jabref/issues/13689)
...
The test case shows that the "Find unlinked files" dialog can now show the user the entries that the files can be linked to.

### Steps to run the test case:
- open library `issue-13689/issue-13689.bib`
- click `Lookup - Find unlinked files`
