...
- [ ] Summary description is at most 3 sentences (under 80 words) and names no classes, preference keys, or libraries; test steps are one line each; checklist items are marked, not justified (see `AGENTS.md`, "Pull requests").
