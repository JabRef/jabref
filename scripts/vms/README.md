...
making
use
of [Vagrant](https://www.vagrantup.com/)
to
install
virtual
machines
...
to '
`C:\Users\$username\VirtualBox VMs\jabref-ubuntu`'
to
save
the
settings
...
is
available
at <https://snapcraft.io/docs/quickstart-tour>.
...
Look
at <https://stackoverflow.com/a/78040474/873282>.
