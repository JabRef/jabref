...
cd ~/downloads
wget --quiet -nc http://download-keycdn.ej-technologies.com/install4j/install4j_unix_7_0_2.tar.gz
...
tar -xf ~/downloads/install4j_unix_7_0_2.tar.gz
# fix directory name (until install4j 6.1.5 it was install4j6
mv install4j7.0.2 install4j7
