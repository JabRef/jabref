...
cd ~/.install4j7/jres/
wget --quiet -nc https://files.jabref.org/jres/windows-x86-1.8.0_162.tar.gz
wget --quiet -nc https://files.jabref.org/jres/windows-amd64-1.8.0_162.tar.gz
wget --quiet -nc https://files.jabref.org/jres/macosx-amd64-1.8.0_162_unpacked.tar.gz
