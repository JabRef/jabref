...
0
$ "$JABKIT" pseudonymize --input=src/test/resources/org/jabref/toolkit/commands/origin.bib --output=/tmp/origin.pseudo.bib --key=/tmp/origin.pseudo.csv 2>/dev/null | grep "Pseudonymizing library"
