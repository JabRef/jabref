...
$ "$JABKIT" git merge-driver --porcelain src/test/resources/org/jabref/toolkit/commands/merge-base.bib build/tmp/merge-current.bib src/test/resources/org/jabref/toolkit/commands/merge-other.bib 2>build/tmp/merge-driver.err; echo $?
0
$ cat build/tmp/merge-driver.err
