...
extraJavaModuleInfo {
    ...
    knownModule(
        ...
        "org.freedesktop.dbus.transport.jre"
    )
    ...
    module(
        ...
        requires(
            "java.compiler"
        ) // Reason: javax.annotation.processor
    }
    ...
    module(
        ...
        "com.github.tomtung.latex2unicode"
    ) {
        exportAllPackages()
    ...
    module(
        "com.squareup.okhttp3:okhttp-jvm-sse",
        "okhttp3.sse"
    )
    module(
    ...
    module(
        ...
        "io.github.darvil.terminal.textformatter"
    ) {
        patchRealModule()
        exportAllPackages()
        requires(
            "io.github.darvil.utils"
        )
    }
    module(
        "io.github.darvil82:utils",
        "io.github.darvil.utils"
    ) {
        patchRealModule()
        exportAllPackages()
    ...
    module(
        "io.zonky.test.postgres:embedded-postgres-binaries-linux-amd64-alpine",
    ...
    module(
        "org.eclipse.lsp4j:org.eclipse.lsp4j.jsonrpc.debug",
    ...
    module(
        "org.eclipse.xtend:org.eclipse.xtend",
        "xtend"
    ) {
        exportAllPackages()
    }
    ...
    module(
        ...
        "com.tngtech.archunit.junit5.engine"
    ) {
        exportAllPackages()
        requireAllDefinedDependencies()
    }
    module(
        "com.tngtech.archunit:archunit-junit5-engine-api",
        "com.tngtech.archunit.junit5.engineapi"
    ) {
        exportAllPackages()
        requireAllDefinedDependencies()
    }
    ...
    module(
        "com.github.sialcasa.mvvmFX:mvvmfx-validation",
        "de.saxsys.mvvmfx.validation"
    ) {
        exportAllPackages()
        requireAllDefinedDependencies()
    ...
    module(
        ...
        "com.google.errorprone.core"
    )
    module(
        "com.google.errorprone:error_prone_check_api",
        "com.google.errorprone.check.api"
    )
    module(
...
val consistentResolutionAttribute =
    Attribute.of(
