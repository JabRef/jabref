...
installed,
you
can [download gg.cmd](https://github.com/eirikb/gg/releases/latest/download/gg.cmd)
and
then
run
`sh -x gg.cmd jbang doi_to_bibtex.java`
on
Linux.
On
Windows,
...
You
can
also [download and install JBang](https://www.jbang.dev/download/)
and
then
just
run:
