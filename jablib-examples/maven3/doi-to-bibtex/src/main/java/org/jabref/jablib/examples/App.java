...
public class App {
    public static void main(String[] args) {
        ...
        try (OutputStreamWriter writer = new OutputStreamWriter(System.out, StandardCharsets.UTF_8)) {
            ...
            JournalAbbreviationRepository abbreviationRepository = JournalAbbreviationLoader.loadRepository(preferences.getJournalAbbreviationPreferences());
            BibDatabaseWriter bibWriter = new BibDatabaseWriter(writer, context, preferences, abbreviationRepository);
