...
public class Server {
    ...
    public static void main(final String[] args)
        ...
        final ObservableList<String> lastFilesOpened = JabRefPreferences
            .getInstance()
            .getGuiPreferences()
            .getLastFilesOpened();
    ...
    private static void startServer() {
        ...
        SeBootstrap
            .start(Application.class, configuration)
            .thenAccept(instance -> {
                LOGGER.debug("Server started.");
                instance.stopOnShutdown(stopResult ->
                    System.out.printf(
                        "Stop result: %s [Native stop result: %s].%n",
                        stopResult,
                ...
                System.out.printf(
                    "Instance %s running at %s [Native handle: %s].%n",
                    instance,
                    uri,
