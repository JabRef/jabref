...
public interface DialogService {
    ...
    /**
     * This will create and display new {@link ChoiceDialog} of type T
     * with a default choice and a collection of possible choices
     *
     * @impl Note The implementation should accept {@code null} for
     * {@code defaultChoice}, but callers should use
     * {@link #showChoiceDialogAndWait(String, String, String, Collection)}.
     */
    <T> Optional<T> showChoiceDialogAndWait(String title,
                                            String content,
    ...
    /**
     * This will create and display new {@link ChoiceDialog}
     * of type T with a collection of possible choices
     */
    default <T> Optional<T> showChoiceDialogAndWait(String title,
                                                    String content,
                                                    String okButtonLabel,
                                                    Collection<T> choices) {
    ...
    /**
     * This will create and display new {@link TextInputDialog}
     * with a text field to enter data
     */
    Optional<String> showInputDialogAndWait(String title, String content);

    /**
     * This will create and display new {@link TextInputDialog}
     * with a text field with a default value to enter data
     */
    Optional<String> showInputDialogWithDefaultAndWait(String title,
                                                       String content,
                                                       String defaultValue);
     ...
     * a single OK Button.
     *
     * To create an information dialog with custom
     * buttons see also
     * {@link #showCustomButtonDialogAndWait(Alert.AlertType, String, String, ButtonType...)}
     */
    void showInformationDialogAndWait(String title, String content);

    /**
     * This will create and display a new warning dialog.
     *
     * It will include a yellow warning icon on the left and
     * a single OK Button.
     *
     * To create a warning dialog with custom
     * buttons see also
     * {@link #showCustomButtonDialogAndWait(Alert.AlertType, String, String, ButtonType...)}
     */
     ...
     * a single OK Button.
     *
     * To create a error dialog with custom
     * buttons see also 
     * {@link #showCustomButtonDialogAndWait(Alert.AlertType, String, String, ButtonType...)}
     */
     ...
     *
     * To create a confirmation dialog with custom
     * buttons see also 
     * {@link #showCustomButtonDialogAndWait(Alert.AlertType, String, String, ButtonType...)}
     *
     ...
     *
     * It will include a blue question icon on the left and
     * a OK (with given label) and Cancel button.
     *
     * To create a confirmation dialog with custom
     * buttons see also
     * {@link #showCustomButtonDialogAndWait(Alert.AlertType, String, String, ButtonType...)}.
     ...
     *
     * It will include a blue question icon on the left and
     * a OK (with given label) and Cancel (also with given label) button.
     *
     * To create a confirmation dialog with custom
     * buttons see also
     * {@link #showCustomButtonDialogAndWait(Alert.AlertType, String, String, ButtonType...)}.
     ...
     * @return true if the use clicked "OK" otherwise false
     */
    boolean showConfirmationDialogAndWait(String title,
                                          String content,
                                          String okButtonLabel,
     ...
     *
     * It will include a blue question icon on the left and
     * a YES (with given label) and Cancel (also with given label) button.
     *
     * To create a confirmation dialog with custom
     * buttons see also
     * {@link #showCustomButtonDialogAndWait(Alert.AlertType, String, String, ButtonType...)}.
     *
     * Moreover, the dialog contains a opt-out checkbox with the given
     * text to support "Do not ask again"-behaviour.
     *
     * @return true if the use clicked "YES" otherwise false
     */
    boolean showConfirmationDialogWithOptOutAndWait(String title,
                                                    String content,
     ...
     */
    Optional<ButtonType> showCustomButtonDialogAndWait(Alert.AlertType type,
                                                       String title,
                                                       String content,
     ...
     * @return Optional with the pressed Button as ButtonType
     */
    Optional<ButtonType> showCustomDialogAndWait(String title,
    ...
    /**
     * Constructs and shows a canceable {@link ProgressDialog}.
     *
     ...
     */
    <V> Optional<ButtonType> showBackgroundProgressDialogAndWait(String title,
                                                                 String content,
     ...
     *
     * Doesn't return until the displayed file save dialog is
     * dismissed.
     *
     * The return value specifies the file chosen by the user or an
     * empty {@link Optional} if no selection has been made.
     *
     * After a file was selected, the given file dialog configuration
     * is updated with the selected extension type (if any).
     *
     ...
     *
     * Doesn't return until the displayed open dialog is dismissed.
     *
     * The return value specifies the file chosen by the user or an
     * empty {@link Optional} if no selection has been made.
     *
     ...
     * made.
     *
     * @return the selected files or an empty {@link List} if no file
     *         has been selected
     */
     ...
     * empty {@link Optional} if no selection has been made.
     *
     * @return the selected directory or an empty {@link Optional} if
     ...
     *
     * The print dialog is also used to confirm the user wants to
    ...
    /**
     * Shows a new dialog that list all files contained in the given
     * archive and which lets the user select one of these files.
     *
     * Doesn't return until the displayed open dialog is dismissed.
     *
     * The return value specifies the file chosen by the user or an
     * empty {@link Optional} if no selection has been made.
     *
     * @return the selected file or an empty {@link Optional} if no
