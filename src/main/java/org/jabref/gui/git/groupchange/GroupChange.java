...
public final class GroupChange extends GitChange {
    private final GroupDiff groupDiff;

    public GroupChange(GroupDiff groupDiff, GitContext databaseContext, GitChangeResolverFactory databaseChangeResolverFactory) {
