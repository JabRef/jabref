...
public final class EntryChangeDetailsView extends GitChangeDetailsView {
    ...
    private void setBottomAnchor(SplitPane split, double d) {
    }

    private void setRightAnchor(SplitPane split, double d) {
    }

    private void setTopAnchor(SplitPane split, double d) {
    }

    private void setLeftAnchor(SplitPane split, double d) {
    }
}
