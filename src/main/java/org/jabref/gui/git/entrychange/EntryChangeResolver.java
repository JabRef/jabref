...
import org.jabref.gui.git.GitChangeResolver;
...
public final class EntryChangeResolver extends GitChangeResolver {
    ...
    public EntryChangeResolver(EntryChange entryChange, DialogService dialogService, BibGitContext databaseContext, PreferencesService preferencesService) {
        super(dialogService);
