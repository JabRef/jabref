...
public class PreviewWithSourceTab {
    ...
    public TabPane getPreviewWithSourceTab(BibEntry oldEntry, BibGitContext databaseContext, PreferencesService preferencesService, BibEntryTypesManager entryTypesManager, PreviewViewer previewClone, String lang) {
        return null;
    }

    public TabPane getPreviewWithSourceTab(BibEntry entry, BibGitContext bibGitContext, PreferencesService preferencesService, BibEntryTypesManager entryTypesManager, PreviewViewer previewViewer) {
        return null;
    }
}
