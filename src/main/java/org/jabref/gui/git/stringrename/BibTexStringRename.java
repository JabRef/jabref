...
public final class BibTexStringRename extends GitChange {
    ...
    public BibTexStringRename(BibtexString oldString, BibtexString newString, GitContext databaseContext, GitChangeResolverFactory databaseChangeResolverFactory) {
    ...
    public void applyChange(NamedCompound undoEdit) {
        if (databaseContext.getGit().hasStringByName(newString.getName())) {
