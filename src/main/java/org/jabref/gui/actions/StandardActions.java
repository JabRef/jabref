...
public enum StandardActions implements Action {
    ...
    CREATE_GROUP_FROM_SELECTION(Localization.lang("Create group from selection")),
    CREATE_SUBGROUP_FROM_SELECTION(Localization.lang("Create subgroup from selection")),
