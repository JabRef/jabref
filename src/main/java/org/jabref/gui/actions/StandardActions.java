...
public enum StandardActions implements Action {
    ...
    QUALITY_ASSURED(
        ...
        IconTheme.JabRefIcons.QUALITY_ASSURED
    ),
    ...
    CUSTOMIZE_KEYBINDING(
        ...
        IconTheme.JabRefIcons.KEY_BINDINGS
    ),
    ...
    MOVE_FILE_TO_FOLDER(
        Localization.lang("Move file to file directory"),
        IconTheme.JabRefIcons.MOVE_TO_FOLDER
    ),
    ...
    ERROR_CONSOLE(
        Localization.lang("View event log"),
        Localization.lang("Display all error messages")
    ),
