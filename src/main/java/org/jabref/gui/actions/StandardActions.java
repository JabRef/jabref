...
public enum StandardActions implements Action {
    ...
    QUALITY_HIGH(Localization.lang("Set quality to high"), IconTheme.JabRefIcons.QUALITY_ASSURED),
    QUALITY_MEDIUM(Localization.lang("Set quality to medium"), IconTheme.JabRefIcons.QUALITY_ASSURED),
    QUALITY_LOW(Localization.lang("Set quality to low"), IconTheme.JabRefIcons.QUALITY_ASSURED),
