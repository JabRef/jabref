...
public enum StandardActions implements Action {
    ...
    QUALITY_HIGH(Localization.lang("Set quality to high"), IconTheme.JabRefIcons.QUALITY_HIGH),
    QUALITY_MEDIUM(Localization.lang("Set quality to medium"), IconTheme.JabRefIcons.QUALITY_MEDIUM),
    QUALITY_LOW(Localization.lang("Set quality to low"), IconTheme.JabRefIcons.QUALITY_LOW),
    ...
    NOT_READ(Localization.lang("Set read status to not read"), IconTheme.JabRefIcons.READ_STATUS_TOBE, KeyBinding.NOT_READ),
