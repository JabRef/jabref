...
public enum StandardActions implements Action {
    ...
    RELEVANT(Localization.lang("Set relevant"), IconTheme.JabRefIcons.RELEVANCE, KeyBinding.RELEVANT),
    IRRELEVANT(Localization.lang("Set irrelevant"), KeyBinding.IRRELEVANT),
