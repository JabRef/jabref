...
public class MainTableHeaderContextMenu extends ContextMenu {
    ...
    private void constructItems(MainTable mainTable) {
        ...
        MenuItem showMoreItem = actionfactory.createMenuItem(RightClickMenuActions.SHOW_PREFS_RIGHT_CLICK_MENU, new ShowPreferencesAction(frame, taskExecutor, new TableTab()));
