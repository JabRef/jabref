...
public class RightClickMenu {
    ...
    public static ContextMenu create(
        ...
        contextMenu
            ...
            .addAll(
                ...
                new SeparatorMenuItem(),
                factory.createMenuItem(
                    StandardActions.ATTACH_FILE,
                    new AttachFileAction(
                        libraryTab,
                        dialogService,
                        stateManager,
                ...
                factory.createMenuItem(
                    StandardActions.ATTACH_FILE_FROM_URL,
                    new AttachFileFromURLAction(
                        dialogService,
                        stateManager,
                        taskExecutor,
                        preferencesService
    ...
    private static Menu createCopySubMenu(
        ...
        if (
            ...
            copySpecialMenu
                ...
                .addAll(
                    factory.createMenuItem(
                        StandardActions.COPY_CITATION_HTML,
                    ...
                    factory.createMenuItem(
                        StandardActions.COPY_CITATION_TEXT,
                        new CopyCitationAction(
        ...
        copySpecialMenu
            ...
            .addAll(
                new SeparatorMenuItem(),
                factory.createMenuItem(
                    StandardActions.EXPORT_TO_CLIPBOARD,
    ...
    private static Menu createSendSubMenu(
        ActionFactory factory,
        DialogService dialogService,
        StateManager stateManager,
        PreferencesService preferencesService,
