...
public class ContentSelectorViewModel implements PropertiesTabViewModel {
    ...
    private static final List<Field> DEFAULT_FIELD_NAMES = Arrays.asList(
    ...
    private final ListProperty<Field> fields = new SimpleListProperty<>(
    ...
    public void setValues() {
        ...
        metaData
            .getContentSelectors()
            .getContentSelectors()
            .forEach(existingContentSelector ->
