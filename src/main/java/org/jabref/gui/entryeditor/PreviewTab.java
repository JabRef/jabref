...
public class PreviewTab extends EntryEditorTab implements OffersPreview {
    ...
    private final AiEmbeddingsTaskManager aiEmbeddingsTaskManager;
    ...
    public PreviewTab(BibDatabaseContext databaseContext,
        ...
        this.aiEmbeddingsTaskManager = aiEmbeddingsTaskManager;
    ...
    protected void bindToEntry(BibEntry entry) {
        if (previewPanel == null) {
            previewPanel = new PreviewPanel(databaseContext, dialogService, preferences.getKeyBindingRepository(), preferences, stateManager, themeManager, indexingTaskManager, aiEmbeddingsTaskManager, taskExecutor);
