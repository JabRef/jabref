...
public class FileAnnotationTabViewModel extends AbstractViewModel {
    ...
    private final ListProperty<FileAnnotationViewModel> annotations = new SimpleListProperty<>(
    ...
    public void copyCurrentAnnotation() {
        ...
        sj.add(
            Localization.lang("Marking") + ": " + getCurrentAnnotation().markingProperty().get()
        );
