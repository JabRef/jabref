...
public enum KeyBinding {
    ...
    NEW_ENTRY_FROM_PLAIN_TEXT_ONLINE("New entry from plain text", Localization.lang("New entry from plain text (%0)", Localization.lang("online")), "ctrl+shift+N", KeyBindingCategory.BIBTEX),
