...
public enum KeyBinding {
    ...
    PULL_CHANGES_FROM_SHARED_DATABASE("Pull changes from shared database", Localization.lang("Pull changes from shared database"), "alt+shift+R", KeyBindingCategory.FILE),
