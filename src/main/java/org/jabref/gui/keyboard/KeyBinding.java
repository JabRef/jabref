...
public enum KeyBinding {
    ...
    SCROLL_TO_NEXT_RANK("Scroll to next rank", Localization.lang("Scroll to next rank"), "right", KeyBindingCategory.VIEW),
    SCROLL_TO_PREVIOUS_RANK("Scroll to previous rank", Localization.lang("Scroll to previous rank"), "left", KeyBindingCategory.VIEW),
