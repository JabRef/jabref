...
public class IconTheme {
    ...
    public enum JabRefIcons implements JabRefIcon {
        ...
        QUALITY_HIGH(Color.GREEN, MaterialDesignC.CERTIFICATE),
        QUALITY_MEDIUM(Color.ORANGE, MaterialDesignC.CERTIFICATE),
        QUALITY_LOW(Color.RED, MaterialDesignC.CERTIFICATE),
