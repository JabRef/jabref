...
public class IconTheme {
    ...
    public enum JabRefIcons implements JabRefIcon {
        ...
        MOVE_LEFT(MaterialDesignIcon.CHEVRON_LEFT),
        MOVE_UP(MaterialDesignIcon.CHEVRON_UP),
        MOVE_RIGHT(MaterialDesignIcon.CHEVRON_RIGHT),
        MOVE_DOWN(MaterialDesignIcon.CHEVRON_DOWN),
