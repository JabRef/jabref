...
public class WalkFileTreeView extends BackgroundTask<List<Path>> {

    private static final String TEX_EXT = ".tex";

    private final Path directory;

    public WalkFileTreeView(Path directory) {
    ...
    private List<Path> searchDirectory(Path directory) throws IOException {
