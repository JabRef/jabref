...
public interface GUIPostOpenAction {
     ...
     */
    boolean isActionNecessary(ParserResult pr, Preferences preferences);
     ...
     * @param pr    The result of the BIB parse operation.
     */
    void performAction(ParserResult pr, DialogService dialogService, Preferences preferences);
}
