...
public class WebSearchPaneViewModel {
    ...
    public void search() {
        ...
        BackgroundTask<ParserResult> task = BackgroundTask.wrap(() -> new ParserResult(activeFetcher.performSearch(getQuery().trim(), frame.getCurrentBasePanel().getBibDatabaseContext().getMode())))
