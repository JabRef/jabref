...
public class ManageCitationsDialogViewModel {
    ...
    private final ListProperty<CitationEntryViewModel> citations =
    ...
    public ManageCitationsDialogViewModel(
        ...
        Optional<List<CitationEntry>> citationEntries =
            ooBase.guiActionGetCitationEntries();
        ...
        for (CitationEntry entry : citationEntries.get()) {
            CitationEntryViewModel itemViewModelEntry =
                new CitationEntryViewModel(entry);
            citations.add(itemViewModelEntry);
        }
    }

    public void storeSettings() {
        List<CitationEntry> citationEntries = citations
            .stream()
