        ...
        for (Field field : fields) {
            ...
            if (fieldContent.isPresent()) {
                ...
                if (fetcher.isPresent()) {
                    BackgroundTask
                        .wrap(() -> fetcher.get().performSearchById(fieldContent.get()))
                        ...
                        .onFailure(exception -> {
                            ...
                            if (exception instanceof FetcherClientException) {
                                ...
                                dialogService.showInformationDialogAndWait(
                                    ...
                                    Localization.lang("Error occurred %0", exception.getMessage())
                                );
                            }
                        })
    ...
    private void showMergeDialog(
        ...
        if (mergedEntry.isPresent()) {
            NamedCompound ce = new NamedCompound(
                Localization.lang("Merge entry with %0 information", fetcher.getName())
            );
        ...
        BackgroundTask
            ...
            .onSuccess(fetchedEntry -> {
                if (fetchedEntry.isPresent()) {
                    ...
                    dialogService.notify(
                        Localization.lang("Could not find any bibliographic information.")
                    );
                }
            })
            .onFailure(exception -> {
