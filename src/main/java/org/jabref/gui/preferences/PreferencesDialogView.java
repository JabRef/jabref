...
public class PreferencesDialogView extends BaseDialog<PreferencesDialogViewModel> {
    ...
    private final PreferencesTab preferencesTabToSelect;

    public PreferencesDialogView(JabRefFrame frame, PreferencesTab preferencesTabToSelect) {
        this.frame = frame;
        this.setTitle(Localization.lang("JabRef preferences"));
        this.preferencesTabToSelect = preferencesTabToSelect;
    ...
    private void initialize() {
        ...
        if (this.preferencesTabToSelect != null) {
            Optional<PreferencesTab> tabToSelectIfExist = preferenceTabList.getItems()
                                                                           .stream()
                                                                           .filter(prefTab -> prefTab.getTabName().equals(this.preferencesTabToSelect.getTabName()))
                                                                           .findFirst();
