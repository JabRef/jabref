...
public class AiTabViewModel implements PreferenceTabViewModel {
    ...
    public void resetExpertSettings() {
        ...
        int resetContextWindowSize = Optional
                .ofNullable(AiPreferences.CONTEXT_WINDOW_SIZES.get(selectedAiProvider.get()))
                .map(map -> map.getOrDefault(selectedChatModel.get(), 0))
                .orElse(0);
