...
public class GrammarBasedSearchRuleDescriber implements SearchDescriber {
    ...
    public TextFlow getDescription() {
        ...
        textFlow
            ...
            .add(
                TooltipTextUtil.createText(
                    String.format(
                        "%s ",
                        Localization.lang("This search contains entries in which")
                    ),
        ...
        textFlow
            .getChildren()
            .add(TooltipTextUtil.createText(". ", TooltipTextUtil.TextType.NORMAL));
        textFlow
            .getChildren()
            .add(
                TooltipTextUtil.createText(
    ...
    private class DescriptionSearchBaseVisitor extends SearchBaseVisitor<List<Text>> {
        ...
        public List<Text> visitComparison(SearchParser.ComparisonContext context) {
            ...
            final Optional<SearchParser.NameContext> fieldDescriptor = Optional.ofNullable(
                context.left
            );
