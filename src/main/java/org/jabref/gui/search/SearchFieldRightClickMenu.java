...
public class SearchFieldRightClickMenu {
        ...
        contextMenu
            ...
            .addAll(
                factory.createMenuItem(
                    ...
                    new EditAction(StandardActions.UNDO, frame, stateManager)
                ),
                factory.createMenuItem(
                    StandardActions.REDO,
                    new EditAction(StandardActions.REDO, frame, stateManager)
                ),
                factory.createMenuItem(
                    StandardActions.CUT,
                ...
                factory.createMenuItem(
                    ...
                    new EditAction(StandardActions.DELETE, frame, stateManager)
                ),
    ...
    private static Menu createSearchFromHistorySubMenu(
        ...
        Menu searchFromHistorySubMenu = factory.createMenu(() ->
            Localization.lang("Search from history...")
        );
        ...
        if (num == 0) {
            ...
            MenuItem clear = factory.createMenuItem(
