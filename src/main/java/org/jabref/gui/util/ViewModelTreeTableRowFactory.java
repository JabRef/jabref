...
public class ViewModelTreeTableRowFactory<S>
    ...
    public ViewModelTreeTableRowFactory<S> withOnMouseClickedEvent(
        BiConsumer<S, ? super MouseEvent> event
    ) {
        this.onMouseClickedEvent = event;
        return this;
    }

    public ViewModelTreeTableRowFactory<S> withOnMousePressedEvent(
        BiConsumer<S, ? super MouseEvent> event
    ) {
    ...
    public ViewModelTreeTableRowFactory<S> withCustomInitializer(
        Consumer<TreeTableRow<S>> customInitializer
    ) {
        this.toCustomInitializer = customInitializer;
        return this;
    }

    public ViewModelTreeTableRowFactory<S> withContextMenu(
    ...
    public ViewModelTreeTableRowFactory<S> setOnDragEntered(
    ...
    public ViewModelTreeTableRowFactory<S> withEventFilter(
