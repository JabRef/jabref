...
public class StateManager {
    ...
    private final OptionalObjectProperty<FieldChangedEvent> fieldChanged = OptionalObjectProperty.empty();
    ...
    public OptionalObjectProperty<FieldChangedEvent> fieldChangedProperty() {
        return fieldChanged;
    }
