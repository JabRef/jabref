...
public class JabRefFrame extends BorderPane implements OutputPrinter {
    ...
    private Node createToolbar() {
        ...
        HBox rightSide = new HBox(
                                  factory.createIconButton(StandardActions.NEW_ENTRY, new NewEntryAction(this, BiblatexEntryTypes.ARTICLE, dialogService)),
    ...
    private MenuBar createMenu() {
        ...
        library.getItems().addAll(
                                  factory.createMenuItem(StandardActions.NEW_ARTICLE, new NewEntryAction(this, BibtexEntryTypes.ARTICLE, dialogService)),
                                  factory.createMenuItem(StandardActions.NEW_ENTRY, new NewEntryAction(this, dialogService)),
                                  factory.createMenuItem(StandardActions.NEW_ENTRY_FROM_PLAINTEX, new NewEntryFromPlainTextAction(this, Globals.prefs.getUpdateFieldPreferences(), dialogService)),
