...
public class JabRefFrame extends BorderPane {
    ...
    private MenuBar createMenu() {
        ...
        quality.getItems().addAll(
                ...
                factory.createMenuItem(StandardActions.MERGE_ENTRIES, new MergeEntriesAction(dialogService, stateManager, prefs.getBibEntryPreferences(), prefs.getGuiPreferences())),
