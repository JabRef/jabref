...
public class JabRefFrame extends BorderPane {
    ...
    private Node createToolbar() {
        ...
        ToolBar toolBar = new ToolBar(
                ...
                new HBox(
                        ...
                        factory.createIconButton(StandardActions.GENERATE_CITE_KEYS, new GenerateCitationKeyAction(this, dialogService, stateManager, taskExecutor)),
    ...
    private MenuBar createMenu() {
        ...
        edit.getItems().addAll(
                ...
                factory.createMenuItem(StandardActions.GENERATE_CITE_KEYS, new GenerateCitationKeyAction(this, dialogService, stateManager, taskExecutor)),
