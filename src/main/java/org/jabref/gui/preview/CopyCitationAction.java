...
public class CopyCitationAction extends SimpleCommand {
    ...
    private List<String> generateCitations() throws IOException {
        ...
        PreviewLayout previewLayout = preferencesService
    ...
    private List<String> generateTextBasedPreviewLayoutCitations() throws IOException {
        ...
        TextBasedPreviewLayout customPreviewLayout = preferencesService
            .getPreviewPreferences()
            .getCustomPreviewLayout();
        StringReader customLayoutReader = new StringReader(
            customPreviewLayout.getText().replace("__NEWLINE__", "\n")
        );
