        ...
        previewView.setOnDragDropped(event -> {
            ...
            if (event.getDragboard().hasContent(DataFormat.FILES)) {
                ...
                if (event.getTransferMode() == TransferMode.MOVE) {
                    ...
                    fileLinker.moveFilesToFileDirRenameAndAddToEntry(entry, files, indexingTaskManager, embeddingsGenerationTask);
                }
                ...
                if (event.getTransferMode() == TransferMode.COPY) {
                    ...
                    fileLinker.copyFilesToFileDirAndAddToEntry(entry, files, indexingTaskManager, embeddingsGenerationTask);
                }
                success = true;
            }
