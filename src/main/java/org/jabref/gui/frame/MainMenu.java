...
public class MainMenu extends MenuBar {
    ...
    private void createMenu() {
        ...
        quality.getItems().addAll(
                ...
                factory.createMenuItem(StandardActions.CHECK_CONSISTENCY, new ConsistencyCheckAction(dialogService, stateManager, preferences, entryTypesManager, (UiTaskExecutor) taskExecutor)),
