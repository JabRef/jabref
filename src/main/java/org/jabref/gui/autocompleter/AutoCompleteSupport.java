...
public class AutoCompleteSupport<E> {
    ...
    private AutoCompleteSuggestionProvider<E> autoCompleter;
     ...
     */
    public AutoCompleteSupport(JTextComponent textComp, AutoCompleteSuggestionProvider<E> autoCompleter,
    ...
    public void install() {
        ...
        final ActionListener acceptAction = e -> {
            ...
            String toInsert = itemToInsert.toString();
    ...
    private void postProcessTextChange() {
        ...
        Collection<E> candidates = autoCompleter.call(AutoCompleterUtil.getRequest(text));
     ...
     * @param autoCompleter the autocompleter providing the data
     */
    public void setAutoCompleter(AutoCompleteSuggestionProvider<E> autoCompleter) {
        this.autoCompleter = autoCompleter;
    }
