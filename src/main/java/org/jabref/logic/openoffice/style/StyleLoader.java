...
public class StyleLoader {
    ...
    public boolean addStyleIfValid(String filename) {
        ...
        try {
            OOBibStyle newStyle = new OOBibStyle(Path.of(filename), layoutFormatterPreferences, encoding);
    ...
    private void loadExternalStyles() {
        ...
        for (String filename : lists) {
            try {
                OOBibStyle style = new OOBibStyle(Path.of(filename), layoutFormatterPreferences, encoding);
