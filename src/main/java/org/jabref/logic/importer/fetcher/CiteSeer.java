...
public class CiteSeer implements SearchBasedFetcher, FulltextFetcher {
    ...
    private static final String PDF_URL =
        "https://" + BASE_URL + "/document?repid=rep1&type=pdf&doi=%s";
    ...
    public List<BibEntry> performSearch(QueryNode luceneQuery) throws FetcherException {
        ...
        try {
            ...
            JsonNode requestResponse = Unirest
                .post(API_URL)
            ...
            Optional<JSONArray> jsonResponse = Optional
                .of(requestResponse)
            ...
            List<BibEntry> fetchedEntries = parser.parseCiteSeerResponse(
                jsonResponse.orElse(new JSONArray())
            );
            return fetchedEntries;
        } catch (ParseException ex) {
            throw new FetcherException(
                "An internal parser error occurred while parsing CiteSeer entries, ",
                ex
            );
        }
    }
