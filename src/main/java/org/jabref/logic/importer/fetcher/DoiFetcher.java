...
import org.jabref.logic.formatter.bibtexfields.NormalizeAmpersandEmDashesFormatter;
...
public class DoiFetcher implements IdBasedFetcher, EntryBasedFetcher {
    ...
    private void doPostCleanup(BibEntry entry) {
        ...
        new FieldFormatterCleanup(StandardField.TITLE, new NormalizeAmpersandEmDashesFormatter()).cleanup(entry);
    }
