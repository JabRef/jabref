...
public class BibsonomyScraper {
     ...
     * @return
     */
    public static Optional<BibEntry> getEntry(String entryUrl, PreferencesService preferencesService) {
        try {
            ...
            return BibtexParser.singleFromString(bibtex, preferencesService, new DummyFileUpdateMonitor());
