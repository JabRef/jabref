...
public class TrustStoreManager {
    ...
    public TrustStoreManager(Path storePath) {
        ...
        try {
            ...
            store.load(
                new FileInputStream(storePath.toFile()),
            ...
            LOGGER.warn(
                "Error while loading trust store from: {}",
    ...
    public void addCertificate(String alias, Path certPath) {
        ...
        try {
            ...
            LOGGER.warn(
                "Error while adding a new certificate to the truststore: {}",
                alias,
                e
            );
        }
    ...
    public void deleteCertificate(String alias) {
        ...
        try {
            ...
            LOGGER.warn(
                "Error while deleting certificate entry with alias: {}",
                alias,
                e
            );
        }
    ...
    public boolean certificateExists(String alias) {
        ...
        try {
            ...
            LOGGER.warn(
                "Error while checking certificate existence: {}",
                alias,
                e
            );
        }
    ...
    public X509Certificate getCertificate(String alias) {
        try {
            ...
            LOGGER.warn(
                "Error while getting certificate of alias: {}",
                alias,
                e
            );
        }
    ...
    public static void createTruststoreFileIfNotExist(Path storePath) {
        try {
            ...
            if (Files.notExists(storePath)) {
                Path storeResourcePath = Path.of(
                    TrustStoreManager.class.getResource("/ssl/truststore.jks")
                        .toURI()
                );
    ...
    private static void configureTrustStore(Path myStorePath)
        ...
        X509TrustManager mergedTrustManager = createMergedTrustManager(
            jreTrustManager,
            myTrustManager
        );
    ...
    private static X509TrustManager createMergedTrustManager(
        X509TrustManager jreTrustManager,
    ...
    private static void setSystemTrustManager(
