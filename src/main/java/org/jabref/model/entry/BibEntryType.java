...
public class BibEntryType implements Comparable<BibEntryType> {
    ...
    public BibEntryType(
        EntryType type,
        Collection<BibField> fields,
        Collection<OrFields> requiredFields
    ) {
    ...
    public Set<Field> getDeprecatedFields(BibDatabaseMode mode) {
        ...
        Set<Field> deprecatedFields = new LinkedHashSet<>(
            EntryConverter.FIELD_ALIASES_BIBTEX_TO_BIBLATEX.keySet()
        );
