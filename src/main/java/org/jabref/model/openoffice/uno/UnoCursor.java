...
public class UnoCursor {
    ...
    public static Optional<XTextViewCursor> getViewCursor(XTextDocument doc) {
        return UnoTextDocument
            .getCurrentController(doc)
     ...
     */
    public static Optional<XTextCursor> getTextCursorOfTextContentAnchor(
        XTextContent mark
    ) {
        if (mark == null) {
        ...
        return Optional.of(
            markAnchor.getText().createTextCursorByRange(markAnchor)
        );
    }
