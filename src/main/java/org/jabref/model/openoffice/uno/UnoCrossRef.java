...
public class UnoCrossRef {
    ...
    public static void insertReferenceToPageNumberOfReferenceMark(
        ...
        try {
            ...
            xFieldProps =
                UnoCast
                    .cast(XPropertySet.class, msf.createInstance(name))
                    .get();
        ...
        try {
            ...
            throw new java.lang.IllegalStateException(
                "The created GetReference does not have property 'SourceName'"
            );
        } catch (PropertyVetoException ex) {
            throw new java.lang.IllegalStateException(
                "Caught PropertyVetoException on 'SourceName'"
            );
        }
        ...
        try {
            ...
            throw new java.lang.IllegalStateException(
                "Caught PropertyVetoException on 'ReferenceFieldSource'"
            );
        }
        ...
        try {
            ...
            throw new java.lang.IllegalStateException(
                "Caught PropertyVetoException on 'ReferenceFieldPart'"
            );
        }

        // Get the XTextContent interface of the GetReference text field
        XTextContent xRefContent = UnoCast
            .cast(XTextContent.class, xFieldProps)
            .get();
