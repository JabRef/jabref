...
public class AppearancePreferences {
    ...
    public AppearancePreferences(boolean shouldOverrideDefaultFontSize, int mainFontSize, int defaultFontSize, Theme theme,boolean automaticThemeDetectionFlag) {
