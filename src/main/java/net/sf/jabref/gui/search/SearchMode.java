...
public enum SearchMode {
    Incremental(
            Localization.lang("Incremental"),
            Localization.lang("Incremental search")),
    Float(
    ...
    LiveFilter(
            Localization.lang("Live filter"),
            Localization.lang("Automatically hide non-matching entries")),
    ResultsInDialog(
            Localization.lang("Show results in dialog"),
            Localization.lang("Show search results in a window")),
    Global(
