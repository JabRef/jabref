...
public class MainTableFormat implements TableFormat<BibEntry> {
    ...
    private static final List<String> URL_FIRST = Arrays.asList(FieldName.URL_FIELD, FieldName.DOI_FIELD);
    private static final List<String> DOI_FIRST = Arrays.asList(FieldName.DOI_FIELD, FieldName.URL_FIELD);
