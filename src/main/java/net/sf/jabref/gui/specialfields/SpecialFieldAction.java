...
public class SpecialFieldAction implements BaseAction {
    ...
    private String getTextDone(SpecialField field, String... params) {
        ...
        if (field.isSingleValueField() && (params.length == 1) && (params[0] != null)) {
            ...
            return Localization.lang("Toggled '%0' for %1 entries", Localization.lang(field.getLocalizationKey()), params[0]);
            ...
            String[] allParams = {Localization.lang(field.getLocalizationKey()), params[0], params[1]};
            ...
            return Localization.lang("Cleared '%0' for %1 entries", Localization.lang(field.getLocalizationKey()), params[0]);
        } else {
            // invalid usage
