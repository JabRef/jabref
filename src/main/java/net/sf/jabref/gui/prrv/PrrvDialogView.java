...
public class PrrvDialogView extends FXMLView {
    ...
    public void show() {
        try {
            ...
            alert.setTitle("Error while loading references");
            alert.setHeaderText("All used entry types need an optional field named references");
            alert.setContentText("Should JabRef insert them automatically?\n"
                    + "Node:\n "
