...
public class HTMLUnicodeConversionMaps {
    ...
    public static final Map<String, String> ESCAPED_SYMBOLS = new HashMap<>();
    public static final Map<Integer, String> ESCAPED_ACCENTS = new HashMap<>();
    public static final Map<Integer, String> NUMERICAL_SYMBOLS = new HashMap<>();
    public static final Map<Character, String> UNICODE_SYMBOLS = new HashMap<>();
        ...
        for (String[] aConversionList : CONVERSION_LIST) {
            if (!(aConversionList[2].isEmpty())) {
                if (!(aConversionList[1].isEmpty())) {
                    ESCAPED_SYMBOLS.put("&" + aConversionList[1] + ";", aConversionList[2]);
                }
                if (!(aConversionList[0].isEmpty())) {
                    NUMERICAL_SYMBOLS.put(Integer.decode(aConversionList[0]), aConversionList[2]);
                    if (Integer.decode(aConversionList[0]) > 128) {
                        Character c = (char) Integer.decode(aConversionList[0]).intValue();
                        UNICODE_SYMBOLS.put(c, aConversionList[2]);
                    }
                }
            }
        }
