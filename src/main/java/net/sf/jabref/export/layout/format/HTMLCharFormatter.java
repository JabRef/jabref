...
public class HTMLCharFormatter implements LayoutFormatter {
    ...
    private static HtmlCharsMap htmlChars= new HtmlCharsMap();
        ...
        for (i = 0; i < field.length(); i++) {
            ...
            if (escaped && (c == '\\')) {
                ...
                if (incommand) {
                    ...
                    Object result = htmlChars.get(command);
                    if (result != null) {
                ...
                if (!incommand) {
                    ...
                    testCharCom: if ((currentCommand.length() == 1)
                        ...
                        Object result = htmlChars.get(command + combody);
                ...
                if (!incommand) {
                    ...
                    if (command.equals("em") || command.equals("emph") || command.equals("textit")) {
                        ...
                        if (argument != null) {
                            ...
                            Object result = htmlChars.get(command + argument);
