...
public class JabRefPreferences {
    ...
    */
    ...
    private JabRefPreferences() {
        ...
        defaults.put(TEXMAKER_PATH, OS.getNativeDesktop().guessProgramPath("texmaker", "Texmaker"));
        defaults.put(WIN_EDT_PATH, OS.getNativeDesktop().guessProgramPath("WinEdt", "WinEdt Team\\WinEdt"));
        defaults.put(LATEX_EDITOR_PATH, OS.getNativeDesktop().guessProgramPath("LEd", "LEd"));
        defaults.put(TEXSTUDIO_PATH, OS.getNativeDesktop().guessProgramPath("texstudio", "TeXstudio"));
