 ...
 */
class OldStyleSelectDialog {

    private static final Log LOGGER = LogFactory.getLog(OldStyleSelectDialog.class);
    ...
    public OldStyleSelectDialog(JabRefFrame frame, String initSelection) {
