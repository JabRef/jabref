...
public class ListAutoCompleteRenderer<E> extends AutoCompleteRenderer<E> {
	...
	/**
	 * Every selection change by the user is interpreted as accepting the new item as autocompletion.
	 * Thus we need this helper variable to prevent that also programmatical trigger an autocompletion.
	 */
