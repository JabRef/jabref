...
<body>
    ...
    sup&eacute;rieur</h2>Suivez les &eacute;tapes suivantes pour
    ...
    <ul>
        ...
        Base -&gt; Base de donn&eacute;es</b></li>

        <li>&Eacute;diter la base de donn&eacute;es
        ...
        <li>Fermer la fen&ecirc;tre <b>Options</b> et choisir
        <b>Fichier -&gt; Nouveau -&gt; Base de
        donn&eacute;es</b></li>

        <li>Choisir <b>Se connecter &agrave; une base de
        donn&eacute;es existante</b>, s&eacute;lectionner
        <b>Classeur</b> comme type de base de donn&eacute;es,
        cliquer sur <b>Suivant</b> et choisir le fichier
        <b>.ods</b> que vous avez export&eacute;.</li>

        <li>Cliquer sur <b>Terminer</b>, puis choisir le nom
        <i>Bibliographie</i> quand demand&eacute;.</li>
    </ul>Apr&egrave;s avoir effectu&eacute; ces &eacute;tapes,
    choisir <b>Outils -&gt; Base de donn&eacute;es
    ...
    <ul>
        ...
        <li>D&eacute;marrer OpenOffice.org Texte</li>

        <li>Choisir <b>Outils -&gt; Sources de
        donn&eacute;es...</b></li>

        <li>S&eacute;lectionner la base de donn&eacute;es
        <i>Bibliography</i> et lui donner un autre nom, tel que
        <i>Bibliography-old</i>. Cliquer sur <b>Appliquer</b>.</li>

        <li>Cliquer sur <b>Nouvelle source de donn&eacute;es</b>.
        Une nouvelle entr&eacute;e appara&icirc;t. La renommer
        <i>Bibliography</i>.</li>

        <li>Changer le <b>type de BD</b> en <b>Classeur</b>.
        Cliquer le bouton <b>...</b> au bout de la ligne <b>URL de
        la source de donn&eacute;es</b>. Choisir le fichier
        <b>.sxc</b> que vous avez export&eacute;.</li>

        <li>Cliquer sur <b>OK</b> pour fermer la fen&ecirc;tre
        <b>Gestion des sources de donn&eacute;es</b>.</li>
    </ul>Apr&egrave;s avoir effectu&eacute; ces &eacute;tapes,
    choisir <b>Outils -&gt; Base de donn&eacute;es
    bibliographique</b>. Votre base de donn&eacute;es devrait
    maintenant s'afficher. 
