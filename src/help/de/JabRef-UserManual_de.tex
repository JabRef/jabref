...
Feldnamen, die mit einem Stern* versehen sind, werden nicht direkt von \jabref{} unterstützt, können aber eingebunden werden (siehe \nameref{CustomEntriesHelp} %Eintragstypen anpassen
).
...
\end{itemize}
Für weitere Erläuterungen zu \bibtex{} wird verwiesen auf \cite{Markey2005,btxdoc,btxhak,Raichle2002}.
...
\paragraph{Verfeinernde Untergruppen und einbeziehende Obergruppen mischen}
...
\begin{itemize}
  ...
  \item Um zu überprüfen, ob das Schreiben der Metadaten funktioniert hat, öffnen Sie die Datei in Adobe Acrobat und wählen \menu{Datei \msep{} Dokumenteigenschaften} und dann unter dem Reiter \menu{Beschreibung} die Schaltfläche \menu{Zusätzliche Metadaten}. Wenn Sie links ">Erweitert"< auswählen, sollten Sie im rechten Teil des Dialogs einen Eintrag \texttt{http://jabref.sourceforge.net/bibteXMP} sehen, der die entsprechenden Metadaten enthält. 
\end{itemize}
...
\clearpage 
\section{Weitere Hilfen}
Falls Sie weitere Fragen zu \jabref{} haben, die das Handbuch nicht beantworten konnte, haben Sie folgende Möglichkeiten, zu einer Antwort zu kommen:
\begin{enumerate}
	\item Schauen Sie in der \href{http://jabref.sourceforge.net/faq.php}{FAQ-Liste} auf der \jabref{}-Homepage nach.
...
haben, möchte ich Thomas Fritz und Axel Junge für ihre hilfreichen Tipps und
...
\subsection*{30.\,11.\,2006}
\begin{revhist}
\item Abschnitte ">Weitere Hilfen"< hinzugefügt
\end{revhist}

\subsection*{28.\,11.\,2006}
\begin{revhist}
