...
\emph{Klassen}, die Dateinhalte aus einem sogenannten \emph{Input stream} lesen
...
\menu{Optionen} \msep{} \emph{\menu{Verwalte externe Importfilter}}, und klicken Sie auf
\emph{\menu{Aus Klassenpfad hinzufügen}}. Ein Dateiauswahl-Fenster erscheint, 
...
wählen Sie die <i>.class</i>-Datei Ihres Importers, die von \texttt{\textbackslash{}ImportFormat] abgeleitet
ist. Wenn Sie \emph{\menu{Klasse auswählen}} klicken, erscheint Ihr neuer Importer
in der Liste der externen Importfilter. Alle externen Importfilter erscheinen in den
JabRef-Submenüs \menu{Datei} \msep{} \menu{Importieren} \msep{} \menu{Externe Importfilter} und 
...
Erzeugen Sie in einem Text-Editor eine von <code>ImportFormat</code> abgeleitete Klasse,
...
Öffnen Sie in \jabref{} \menu{Optionen} \msep{} \emph{\menu{Verwaltung externer Importfilter}} und klicken Sie
auf \emph{\menu{Aus Klassenpfad hinzufügen}}. Navigieren Sie nach \texttt{/meinpfad} und 
klicken Sie \emph{\menu{Klassenpfad auswählen}}. Wählen Sie dann \texttt{SimpleCsvImporter.class}
und klicken Sie \emph{\menu{Klasse auswählen}}. Ihr Importfilter sollte nun in der Liste der
externen Importfilter unter dem Namen "Simple CSV Importer" erscheinen, und,
sobald Sie \emph{\menu{Schließen}} gewählt haben, auch in den Untermenüs \menu{Datei} \msep{} \menu{Importieren} \msep{} 
\menu{Externe Importfilter} und \menu{Datei} \msep{} \menu{Importieren und Anhängen} \msep{} \menu{Externe Importfilter} 
des \jabref{}-Hauptfensters.
