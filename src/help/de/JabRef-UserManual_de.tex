...
\newcommand{\versiondate}{18.\,4.\,2007}
...
\hyphenation{For-mat-erken-nung}
...
sowie im Programm selbst unter \menu{Hilfe} \msep{} \menu{Inhalt}. Wer dann immer noch keine Antwort auf seine Frage oder keine Lösung zu seinem Problem hat, kann über die Foren oder die Mailingliste auf der Projektseite bei Sourceforge weitere Hilfe bekommen (siehe dazu den Abschnitt \nameref{sec:faq}).
...
\noindent Im Folgenden können nur einige allgemeine Hinweise gegeben werden. Ausführlichere Einführungen und weitere Erläuterungen zu \bibtex{} finden Sie bei \cite{Fenn2006,Markey2005,btxdoc,btxhak,Raichle2002,btxfaq}.
...
\subsubsection[JabRef -> EndNote]{\jabref{} $\to$~EndNote}\label{subsubsec:jabref-endnote}
...
Mit einem Set von Literaturangaben können Sie eine Liste von Dokumenten generieren, die die Elemente dieses Sets zitieren. Dazu muss jede Literaturangabe in einer Datei ein \emph{citeseerurl}-Feld mit dem eben beschriebenen Format haben.%
%\footnote{Hinweis des Übersetzers (DW): Offen gesagt habe ich diesen Absatz nicht wirklich verstanden, was daran liegen mag, dass ich CiteSeer nicht kenne und deshalb auch die Funktionsweise nicht nachvollziehen kann. Für Hinweise, Erklärungen oder eine bessere Übersetzung wäre ich deshalb dankbar.%
%}
...
indem Sie das \texttt{net.sf.jabref\allowbreak .export.layout.LayoutFormatter}-Interface
implementieren. Wenn Sie in das Paket \texttt{net.sf.jabref.export.layout.format} Ihre Klasse (class) einfügen, können Sie den Formatierer mit seinem Klassennamen aufrufen,
...
Erzeugen Sie in einem Text"=Editor eine Klasse, die von von \texttt{ImportFormat} abgeleitet
...
\begin{enumerate}
	...
	\item Durchsuchen Sie das \href{http://sourceforge.net/mailarchive/forum.php?forum_id=36852}{Archiv} der \jabref{}-Mailingliste.
...
Neben den Entwicklern, die die Hilfe"=Seiten des Programms geschrieben haben, danke ich Robert Bitsche, Thomas Fritz, Axel Junge, Jan Suhr und Tobias Wolf für ihre hilfreichen Tipps und Anmerkungen zum Handbuch.
...
\begin{revhist}{\versiondate}%18.\,4.\,2007}
\item Abschnitte \nameref{StringEditorHelp}, \nameref{par:Feldformatierer} und \nameref{LabelPatterns} aktualisiert
