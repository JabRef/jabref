...
\clearpage 
\section{Häufige Fragen und Antworten (FAQ)}\label{sec:faq}
%\secttoc
...
\faq{Läuft \jabref{} unter freiem Java (Classpath, Kaffee GCJ etc.)?}{Leider führt eine unserer Abhängigkeiten derzeit (13.\,9.\,2006) zu einem Absturz, wenn mit einer anderen Java API als der von Sun gearbeitet wird. Das gilt für Version 0.92 von Classpath. Lassen Sie uns bitte wissen, falls eine neuere Version bei Ihnen läuft. Falls Sie eine Idee haben oder wissen, wie JabRef unter Classpath laufen könnte, teilen Sie uns dies bitte mit.}
