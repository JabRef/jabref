...
\newcommand{\versiondate}{20.\,3.\,2007}
...
Kommandos 
\begin{lstlisting}
\texttt{jar xf <Pfad zur jar-Datei>} 
\end{lstlisting}
bzw. 
\begin{lstlisting}
\texttt{jar xf <Pfad zur jar-Datei> <Liste der Dateien, die entpackt werden sollen>}
\end{lstlisting}
...
Neben den Entwicklern, die die Hilfe"=Seiten des Programms geschrieben haben, danke ich Thomas Fritz, Axel Junge und Tobias Wolf für ihre hilfreichen Tipps und Anmerkungen zum Handbuch.
...
\begin{revhist}{\versiondate}%20.\,3.\,2007}
