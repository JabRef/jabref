%%%%% To do %%%%%
% DW 2007-12-01
% - Doku aus Plugin.html ergänzen (für 2.4)
...
\newcommand{\versiondate}{1.\,12.\,2007}
...
%%% version number
\newcommand{\versionnr}{\texorpdfstring{2.3}{2.3}} %
...
\subsubsection{Datei"=Links zu einem Eintrag hinzufügen}
...
werden.
\item [\texttt{RemoveTilde}]ersetzt das Tilde-Zeichen (\lstinline{~}), das in \LaTeX\ als festes Leerzeichen dient, durch ein normales Leerzeichen. Nützlich in Kombination mit dem Namens"=Formatierer (siehe Abschnitt \nameref{NameFormatter}).
