...
public class KunststoffButtonUI extends MetalButtonUI
{
    ...
    public void paint(Graphics g, JComponent c)
    {
        ...
        if (parent instanceof JToolBar)
        {
            ...
            { // if tool bar orientation is horizontal

                // paint upper gradient
                if (colorReflection != null)
                {
                    Color colorReflectionFaded = KunststoffUtilities.getTranslucentColor(colorReflection,
                            0);
                ...
                if (colorShadow != null)
                {
                    Color colorShadowFaded = KunststoffUtilities.getTranslucentColor(colorShadow,
                            0);
                    rectShadow = new Rectangle(0,
                            (parent.getHeight() / 2) - loc.y,
                            parent.getWidth(), parent.getHeight() / 2);
            ...
            { // if tool bar orientation is vertical
