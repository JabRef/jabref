...
class FastGradientPaintContext implements PaintContext
{
        ...
        boolean ver)
    {
        ...
        else
        {
            gradientCache.put(info,
                new java.lang.ref.WeakReference(gradient = new Gradient(info)));
            ...
            else
            {
                ...
                if (info.isVertical)
                {
                    r = raster.createChild(0, parallelPos,
                            ...
                            info.parallelLength - parallelPos, 0, 0, null);
                }
                else
                {
                    r = raster.createChild(parallelPos, 0,
                            info.parallelLength - parallelPos,
                            this.perpendicularLength, 0, 0, null);
                }
    ...
    private class GradientInfo
    {
        ...
        public boolean equals(Object o)
        {
            ...
            if (gi.model.equals(model) &&
                    (gi.parallelLength == parallelLength) &&
