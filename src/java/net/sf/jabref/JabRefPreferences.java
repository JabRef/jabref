...
public class JabRefPreferences {
	...
	defaults.put("historySize", new Integer(5));
        ...
        defaults.put("preview0", "<font face=\"arial\">"
                     ...
                     +"\\begin{author} \\format[HTMLChars,AuthorLastFirst,AuthorLastFirstAbbreviator,AuthorAndsReplacer]{\\author}<BR>\\end{author}__NEWLINE__"
                     +"\\begin{editor} \\format[HTMLChars,AuthorLastFirst,AuthorLastFirstAbbreviator,AuthorAndsReplacer]{\\editor} <i>(ed.)</i><BR>\\end{editor}__NEWLINE__"
