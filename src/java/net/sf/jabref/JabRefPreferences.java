...
public class JabRefPreferences {
    ...
    private JabRefPreferences() {
        ...
        defaults.put("preview0", "<font face=\"arial\">"
                     ...
                     +"\\begin{author} \\format[HTMLChars,AuthorLastFirst,AuthorAbbreviator,AuthorAndsReplacer]{\\author}<BR>\\end{author}__NEWLINE__"
                     +"\\begin{editor} \\format[HTMLChars,AuthorLastFirst,AuthorAbbreviator,AuthorAndsReplacer]{\\editor} <i>(ed.)</i><BR>\\end{editor}__NEWLINE__"
