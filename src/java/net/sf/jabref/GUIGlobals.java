...
//	copyKeyIconFile = GUIGlobals.class.getResource(pre+"copyKeyIcon.jpg"),
	...
	upIconFile = GUIGlobals.class.getResource(pre+"Up"+ex),
	downIconFile = GUIGlobals.class.getResource(pre+"Down"+ex),
