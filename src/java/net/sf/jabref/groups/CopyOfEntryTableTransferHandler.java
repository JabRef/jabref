...
public class CopyOfEntryTableTransferHandler extends TransferHandler {
	 ...
	 */
	public CopyOfEntryTableTransferHandler(MainTable entryTable, JabRefFrame frame) {
	...
	public Transferable createTransferable(JComponent c) {
		// This method is called when dragging stuff *from* the table, so we can
		// assume
	...
	private void loadOrImportFiles(String[] fileNames) {
		...
		AppendDatabaseAction appendAction = null;
