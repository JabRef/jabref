...
public class EndnoteImporter implements ImportFormat {
	...
	for (int i = 0; i < entries.length; i++){
	    ...
	    //fixauthorscomma
	    if (!Author.equals("")) hm.put("author", ImportFormatReader.fixAuthor_lastnameFirst(Author));
	    if (!Editor.equals("")) hm.put("editor", ImportFormatReader.fixAuthor_lastnameFirst(Editor));
