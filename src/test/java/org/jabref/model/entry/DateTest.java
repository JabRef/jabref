...
class DateTest {
    ...
    private static Stream<Arguments> validDateRanges() {
        return Stream.of(
            ...
            Arguments.of(
                YearMonth.of(2015, Month.JANUARY),
                YearMonth.of(2015, Month.FEBRUARY),
                "2015-01/2015-02"
            ),
            Arguments.of(
                LocalDate.of(2015, Month.JANUARY, 15),
                LocalDate.of(2015, Month.FEBRUARY, 25),
                "2015-01-15/2015-02-25"
            ),
            Arguments.of(
                LocalDate.of(2015, Month.JANUARY, 15),
                LocalDate.of(2015, Month.FEBRUARY, 25),
            ...
            Arguments.of(
                LocalDate.of(2015, Month.JANUARY, 15),
                LocalDate.of(2015, Month.FEBRUARY, 25),
                "15 January 2015/25 February 2015"
            ),
            Arguments.of(
                LocalDate.of(2015, Month.JANUARY, 15),
                LocalDate.of(2015, Month.FEBRUARY, 25),
            ...
            Arguments.of(
                YearMonth.of(-29, Month.JANUARY),
                YearMonth.of(5, Month.FEBRUARY),
                "0030-01 BC/0005-02 AD"
            ),
            Arguments.of(
                YearMonth.of(-29, Month.JANUARY),
                YearMonth.of(5, Month.FEBRUARY),
            ...
            Arguments.of(
                YearMonth.of(-29, Month.JANUARY),
                YearMonth.of(-9, Month.FEBRUARY),
                "0030-01 BC / 0010-02 BC"
            ),
            Arguments.of(
                YearMonth.of(5, Month.JANUARY),
                YearMonth.of(20, Month.FEBRUARY),
                "0005-01 AD / 0020-02 AD"
            )
        );
    }
    ...
    void parseByDatePatternRange(
        Temporal expectedRangeStart,
        Temporal expectedRangeEnd,
        String provided
    ) {
        assertEquals(
            Optional.of(new Date(expectedRangeStart, expectedRangeEnd)),
            Date.parse(provided)
        );
    }
