...
class MainArchitectureTest {
    ...
    public static void doNotUseApacheCommonsLang3(JavaClasses classes) {
        noClasses()
            .that()
            .areNotAnnotatedWith(ApacheCommonsLang3Allowed.class)
            .should()
            .accessClassesThat()
    ...
    public static void doNotUseSwing(JavaClasses classes) {
        ...
        noClasses()
            .that()
            .areNotAnnotatedWith(AllowedToUseSwing.class)
            .should()
            .accessClassesThat()
            .resideInAnyPackage(
                "javax.swing",
    ...
    public static void doNotUseJavaAWT(JavaClasses classes) {
        noClasses()
            .that()
            .areNotAnnotatedWith(AllowedToUseAwt.class)
            .should()
            .accessClassesThat()
            .resideInAPackage(PACKAGE_JAVA_AWT)
            .check(classes);
    }
    ...
    public static void respectLayeredArchitecture(JavaClasses classes) {
        layeredArchitecture()
            ...
            .layer("Gui")
            .definedBy(PACKAGE_ORG_JABREF_GUI)
            .layer("Logic")
            .definedBy(PACKAGE_ORG_JABREF_LOGIC)
            .layer("Model")
            .definedBy(PACKAGE_ORG_JABREF_MODEL)
            .layer("Cli")
            .definedBy(PACKAGE_ORG_JABREF_CLI)
            .layer("Migrations")
            .definedBy("org.jabref.migrations..") // TODO: Move to logic
            .layer("Preferences")
            .definedBy("org.jabref.preferences..")
            .layer("Styletester")
            .definedBy("org.jabref.styletester..")
            .whereLayer("Gui")
    ...
    public static void doNotUseLogicInModel(JavaClasses classes) {
        noClasses()
            ...
            .and()
            .areNotAnnotatedWith(AllowedToUseLogic.class)
            .should()
            .dependOnClassesThat()
            .resideInAPackage(PACKAGE_ORG_JABREF_LOGIC)
            .check(classes);
    }
    ...
    public static void restrictUsagesInModel(JavaClasses classes) {
        ...
        noClasses()
            ...
            .should()
            .dependOnClassesThat()
            .resideInAPackage(PACKAGE_JAVAX_SWING)
            .orShould()
            .dependOnClassesThat()
            .haveFullyQualifiedName(CLASS_ORG_JABREF_GLOBALS)
            .check(classes);
    }
    ...
    public static void restrictStandardStreams(JavaClasses classes) {
        noClasses()
            .that()
            .resideOutsideOfPackages(PACKAGE_ORG_JABREF_CLI)
            .and()
            .resideOutsideOfPackages("org.jabref.gui.openoffice..") // Uses LibreOffice SDK
            .and()
            .areNotAnnotatedWith(AllowedToUseStandardStreams.class)
            .should(GeneralCodingRules.ACCESS_STANDARD_STREAMS)
            .because(
                "logging framework should be used instead or the class be marked explicitly as @AllowedToUseStandardStreams"
            )
            .check(classes);
    }
}
