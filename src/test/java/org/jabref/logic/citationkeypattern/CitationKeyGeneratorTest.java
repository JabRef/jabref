...
class CitationKeyGeneratorTest {
    ...
    private static final BibEntry AUTHOR_FIRSTNAME_INITIAL_LASTNAME_FULL_COUNT_1 =
        createABibEntryAuthor("I. Newton");
    ...
    void testAndInAuthorName() throws ParseException {
        Optional<BibEntry> entry0 = BibtexParser.singleFromString(
            "@ARTICLE{kohn, author={Simon Holland}}",
            importFormatPreferences
        );
        assertEquals(
            "Holland",
            CitationKeyGenerator.cleanKey(
                generateKey(entry0.orElse(null), "[auth]", new BibDatabase()),
                DEFAULT_UNWANTED_CHARACTERS
            )
        );
    }
    ...
    void testCrossrefAndInAuthorNames() {
        ...
        assertEquals(
            "Holland",
            CitationKeyGenerator.cleanKey(
                generateKey(entry1, "[auth]", database),
                DEFAULT_UNWANTED_CHARACTERS
            )
        );
    }
    ...
    void testCrossrefAndAuthorNames() {
        ...
        BibEntry entry2 = new BibEntry()
            ...
            .withField(
                ...
                "Mari D. Herland and Mona-Iren Hauge and Ingeborg M. Helgeland"
            );
        database.insertEntry(entry1);
        database.insertEntry(entry2);
        ...
        assertEquals(
            "HerlandHaugeHelgeland",
            CitationKeyGenerator.cleanKey(
                generateKey(entry1, "[authors3]", database),
                DEFAULT_UNWANTED_CHARACTERS
            )
        );
    }
    ...
    void testSpecialLatexCharacterInAuthorName() throws ParseException {
        ...
        assertEquals(
            "Popovicova",
            CitationKeyGenerator.cleanKey(
                generateKey(entry.orElse(null), "[auth]", new BibDatabase()),
                DEFAULT_UNWANTED_CHARACTERS
            )
        );
    }
    ...
    void testCheckLegalKey(String accents, String expectedResult) {
        assertEquals(
            expectedResult,
            CitationKeyGenerator.cleanKey(accents, DEFAULT_UNWANTED_CHARACTERS)
        );
    }
    ...
    void testcrossrefDepartment() {
        ...
        BibEntry entry2 = new BibEntry()
            ...
            .withField(
                StandardField.AUTHOR,
                "{Link{\\\"{o}}ping University, Department of Electrical Engineering}"
            );
        database.insertEntry(entry1);
        database.insertEntry(entry2);
    ...
    @Test
    void generateKeyAbbreviateCorporateAuthorDepartmentWithoutAcademicInstitute()
        throws ParseException {
        Optional<BibEntry> entry = BibtexParser.singleFromString(
    ...
    @Test
    void generateKeyAbbreviateCorporateAuthorSchoolWithoutAcademicInstitute()
        throws ParseException {
        Optional<BibEntry> entry = BibtexParser.singleFromString(
    ...
    void testcrossrefSchool() {
        ...
        BibEntry entry2 = new BibEntry()
            ...
            .withField(
                StandardField.AUTHOR,
                "{Link{\\\"{o}}ping University, School of Computer Engineering}"
            );
        database.insertEntry(entry1);
        database.insertEntry(entry2);
    ...
    void authAuthEa() {
        assertEquals(
            "Newton",
            generateKey(AUTHOR_FIRSTNAME_FULL_LASTNAME_FULL_COUNT_1, AUTHAUTHEA)
        );
        assertEquals(
            "Newton.Maxwell",
            generateKey(AUTHOR_FIRSTNAME_FULL_LASTNAME_FULL_COUNT_2, AUTHAUTHEA)
        );
        assertEquals(
            "Newton.Maxwell.ea",
            generateKey(AUTHOR_FIRSTNAME_FULL_LASTNAME_FULL_COUNT_3, AUTHAUTHEA)
        );
    }
    ...
    void testAuthEtAl() {
        ...
        assertEquals(
            "Newton.etal",
            generateKey(AUTHOR_FIRSTNAME_FULL_LASTNAME_FULL_COUNT_3, AUTH_ETAL)
        );
        assertEquals(
            "Newton.Maxwell",
            generateKey(AUTHOR_FIRSTNAME_FULL_LASTNAME_FULL_COUNT_2, AUTH_ETAL)
        );

        // [authEtAl]
        assertEquals(
            "NewtonEtAl",
            generateKey(AUTHOR_FIRSTNAME_FULL_LASTNAME_FULL_COUNT_3, AUTHETAL)
        );
        assertEquals(
            "NewtonMaxwell",
            generateKey(AUTHOR_FIRSTNAME_FULL_LASTNAME_FULL_COUNT_2, AUTHETAL)
        );
    }
    ...
    void testAllAuthors() {
        assertEquals(
            "Newton",
            generateKey(AUTHOR_FIRSTNAME_INITIAL_LASTNAME_FULL_COUNT_1, AUTHORS)
        );
        assertEquals(
            "NewtonMaxwell",
            generateKey(AUTHOR_FIRSTNAME_INITIAL_LASTNAME_FULL_COUNT_2, AUTHORS)
        );
        assertEquals(
            "NewtonMaxwellEinstein",
            generateKey(AUTHOR_FIRSTNAME_INITIAL_LASTNAME_FULL_COUNT_3, AUTHORS)
        );
    }
    ...
    static Stream<Arguments> testAuthorsAlpha() {
        return Stream.of(
            ...
            Arguments.of(
                "NM+",
                AUTHOR_FIRSTNAME_FULL_LASTNAME_FULL_AND_OTHERS_COUNT_3,
                AUTHORSALPHA
            )
        );
    }
    ...
    void camel() {
        ...
        assertEquals(
            ...
            CitationKeyGenerator.getCamelizedTitle(TITLE_STRING_CASED)
        );
        assertEquals(
    ...
    void testApplyModifiers() {
        ...
        assertEquals(
            ...
            generateKey(entry, "[shorttitle]", new BibDatabase())
        );
    }
    ...
    void generateKeyWithAuthUpperYearShortTitleCapitalizeModifier() {
        ...
        assertEquals(
            ...
            generateKey(entry, "[auth:upper][year][shorttitle:capitalize]")
        );
    }
