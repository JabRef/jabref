...
public class TexBibEntriesResolverTest {
    ...
    public void testSingleFile() throws URISyntaxException {
        ...
        LatexBibEntriesResolverResult crossingResult = new TexBibEntriesResolver(database, preferencesService, timestampPreferences, fileMonitor).resolve(parserResult);
