...
public class ACMPortalParserTest {
            ...
            List.of(
                new BibEntry(StandardEntryType.Conference)
                    .withField(
                        ...
                        "Olsson, Tobias and Ericsson, Morgan and Wingkvist, Anna"
                    )
    ...
    void testParseDoiSearchPage() throws ParseException, IOException {
        ...
        CookieHandler.setDefault(new CookieManager());
        List<String> doiList = parser.parseDoiSearchPage(
            new URLDownload(searchUrl).asInputStream()
        );
