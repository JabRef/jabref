...
class INSPIREFetcherTest {
    ...
    void searchByQueryFindsEntry() throws Exception {
        ...
        List<BibEntry> fetchedEntries = fetcher.performComplexSearch("Fr\\´echet group actions field");
    ...
    public void searchByIdentifierFindsEntry() throws Exception {
        ...
        List<BibEntry> fetchedEntries = fetcher.performComplexSearch("hep-ph/9802379");
