...
public class GrobidCitationFetcherTest {
    ...
    static ImportFormatPreferences importFormatPreferences = mock(
    ...
    static BibEntry example2AsBibEntry = new BibEntry(BibEntry.DEFAULT_TYPE)
        .withCitationKey("-1")
        .withField(StandardField.AUTHOR, "Thomas, H")
        .withField(
            StandardField.TITLE,
            "Training strategies for improving listeners' comprehension of foreign-accented speech (Doctoral dissertation)"
        )
    ...
    @Test
    public void performSearchThrowsExceptionInCaseOfConnectionIssues()
