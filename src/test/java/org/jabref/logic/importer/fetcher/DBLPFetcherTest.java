...
public class DBLPFetcherTest {
    ...
    public void findSingleEntry() throws FetcherException {
        ...
        List<BibEntry> result = dblpFetcher.performSearch(query, dblpFetcher.getBibFormatOfFetchedEntries());
    ...
    public void findNothing() throws Exception {
        assertEquals(Collections.emptyList(), dblpFetcher.performSearch("", dblpFetcher.getBibFormatOfFetchedEntries()));
    }
}
