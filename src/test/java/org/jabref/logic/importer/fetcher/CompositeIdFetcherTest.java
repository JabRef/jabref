...
class CompositeIdFetcherTest {
    ...
    static void setUpGroundEntriesAndIds() {
        groundInvalidArXivId = "arZiv:2110.02957";

        groundArXivId = "arXiv:2110.02957";
        groundEntryArXiv = new BibEntry(StandardEntryType.Article)
        ...
        groundDOIId = "10.1002/9781118257517";
        groundDOIEntry = new BibEntry(StandardEntryType.Book)
        ...
        groundDOIEntry.setCitationKey("Burd_2011");

        groundIsbnId = "9780134685991";
        groundIsbnEntry = new BibEntry(StandardEntryType.Book)
        ...
        groundIsbnEntry.setCitationKey("9780134685991");

        groundIacrEprintId = "2017/1118";
        groundIacrEprintEntry = new BibEntry(StandardEntryType.Misc)
