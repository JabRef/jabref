...
class CompositeIdFetcherTest {
    ...
    private static Stream<Arguments> performSearchByIdReturnsCorrectEntryForDoiId() {
    ...
    private static Stream<Arguments> performSearchByIdReturnsCorrectEntryForIsbnId() {
        return Stream.of(Arguments.arguments(
                new BibEntry(StandardEntryType.Book)
    ...
    private static Stream<Arguments> performSearchByIdReturnsCorrectEntryForIacrEprintId() {
        return Stream.of(Arguments.arguments(
    ...
    private static Stream<Arguments> performSearchByIdReturnsCorrectEntryForArXivId() {
        return Stream.of(Arguments.arguments(
    ...
    @ParameterizedTest
    @MethodSource
    void performSearchByIdReturnsCorrectEntryForDoiId(BibEntry groundDoiEntry, String groundDoiId) {
        assertEquals(Optional.of(groundDoiEntry), compositeIdFetcher.performSearchById(groundDoiId));
    }

    @ParameterizedTest
    @MethodSource
    void performSearchByIdReturnsCorrectEntryForIsbnId(BibEntry groundIsbnEntry, String groundIsbnId) {
        assertEquals(Optional.of(groundIsbnEntry), compositeIdFetcher.performSearchById(groundIsbnId));
    }

    @ParameterizedTest
    @MethodSource
    void performSearchByIdReturnsCorrectEntryForIacrEprintId(BibEntry groundIacrEprintEntry, String groundIacrEprintId) {
        assertEquals(Optional.of(groundIacrEprintEntry), compositeIdFetcher.performSearchById(groundIacrEprintId));
    }

    @ParameterizedTest
    @MethodSource
    void performSearchByIdReturnsCorrectEntryForArXivId(BibEntry groundEntryArXiv, String groundArXivId) {
        assertEquals(Optional.of(groundEntryArXiv), compositeIdFetcher.performSearchById(groundArXivId));
    }
