...
public class DOABFetcherTest {
    ...
    public void setUp() throws Exception {
        ...
        David_Pol = new BibEntry(StandardEntryType.Book)
                ...
                .withField(StandardField.ABSTRACT, "David Pol presents an ontology of war in the form of " +
        ...
        Ronald_Snijder = new BibEntry(StandardEntryType.Book)
                ...
                .withField(StandardField.ABSTRACT, "In many scholarly disciplines, books - not articles" +
        ...
        Andrew_Perrin = new BibEntry(StandardEntryType.Book)
                ...
                .withField(StandardField.ABSTRACT, "The four kingdoms motif enabled writers of various " +
        ...
        Felipe_Gonzalez = new BibEntry(StandardEntryType.Book)
                ...
                .withField(StandardField.ABSTRACT, "The rapid development and growth of UAVs as a " +
        ...
        Carl_Marnewick = new BibEntry(StandardEntryType.Book)
                ...
                .withField(StandardField.ABSTRACT, "Project success is widely covered, and the " +
        ...
        Antonios_Tsourdos = new BibEntry(StandardEntryType.Book)
                .withField(StandardField.EDITOR, "Felipe Gonzalez Toro and Antonios Tsourdos")
                .withField(StandardField.TITLE, "UAV‐Based Remote Sensing Volume 2")
                .withField(StandardField.PAGES, "VIII, 396")
                .withField(StandardField.YEAR, "2018")
                .withField(StandardField.URI, "https://directory.doabooks.org/handle/20.500.12854/61443")
                .withField(StandardField.ABSTRACT, "ctive technological development has fuelled " +
