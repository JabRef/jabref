...
public class MedlineFetcherTest {
    ...
    public void setUp() {
        ...
        entryWijedasa.setType(BibtexEntryType.Article);
        ...
        entryEndharti.setType(BibtexEntryType.Article);
        ...
        bibEntryIchikawa.setType(BibtexEntryType.Article);
        ...
        bibEntrySari.setType(BibtexEntryType.Article);
