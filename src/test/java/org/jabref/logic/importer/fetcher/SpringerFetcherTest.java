...
class SpringerFetcherTest implements SearchBasedFetcherCapabilityTest {
    ...
    void searchByQueryFindsEntry() throws Exception {
        ...
        List<BibEntry> fetchedEntries = fetcher.performSearch("JabRef Social Barriers Steinmacher", fetcher.getBibFormatOfFetchedEntries());
    ...
    public void supportsPhraseSearch() throws Exception {
        ...
        List<BibEntry> resultPhrase = fetcher.performSearch("name:\"Redmiles David\"", fetcher.getBibFormatOfFetchedEntries());
        List<BibEntry> result = fetcher.performSearch("name:Redmiles David", fetcher.getBibFormatOfFetchedEntries());
    ...
    public void supportsBooleanANDSearch() throws Exception {
        List<BibEntry> resultJustByAuthor = fetcher.performSearch("name:\"Redmiles, David\"", fetcher.getBibFormatOfFetchedEntries());
        List<BibEntry> result = fetcher.performSearch("name:\"Redmiles, David\" AND journal:Computer Supported Cooperative Work", fetcher.getBibFormatOfFetchedEntries());
