...
class SpringerFetcherTest implements SearchBasedFetcherCapabilityTest, PagedSearchFetcherTest {
    ...
    void searchByQueryFindsEntry() throws Exception {
        ...
        List<BibEntry> fetchedEntries = fetcher.performComplexSearch("JabRef Social Barriers Steinmacher");
    ...
    public void supportsPhraseSearch() throws Exception {
        ...
        List<BibEntry> resultPhrase = fetcher.performComplexSearch("author:\"Redmiles David\"");
        List<BibEntry> result = fetcher.performComplexSearch("author:Redmiles David");
    ...
    public void supportsBooleanANDSearch() throws Exception {
        List<BibEntry> resultJustByAuthor = fetcher.performComplexSearch("author:\"Redmiles, David\"");
        List<BibEntry> result = fetcher.performComplexSearch("author:\"Redmiles, David\" AND journal:\"Computer Supported Cooperative Work\"");
