...
class SpringerFetcherTest implements SearchBasedFetcherCapabilityTest, PagedSearchFetcherTest {
    ...
    void searchByQueryFindsEntry() throws Exception {
        BibEntry articleTagThatIssue = new BibEntry(StandardEntryType.Article)
            .withField(
                ...
                "Santos, Fabio and Vargovich, Joseph and Trinkenreich, Bianca and Santos, Italo and Penney, Jacob and Britto, Ricardo and Pimentel, João Felipe and Wiese, Igor and Steinmacher, Igor and Sarma, Anita and Gerosa, Marco A."
            )
            .withField(StandardField.DATE, "2023-08-31")
            .withField(StandardField.DOI, "10.1007/s10664-023-10329-4")
            .withField(
                StandardField.FILE,
                ":http\\://link.springer.com/openurl/pdf?id=doi\\:10.1007/s10664-023-10329-4:PDF"
            )
        ...
        BibEntry firstArticle = new BibEntry(StandardEntryType.Article)
            .withField(
                StandardField.AUTHOR,
                "Steinmacher, Igor and Balali, Sogol and Trinkenreich, Bianca and Guizani, Mariam and Izquierdo-Cortazar, Daniel and Cuevas Zambrano, Griselda G. and Gerosa, Marco Aurelio and Sarma, Anita"
            )
            ...
            .withField(
                StandardField.FILE,
                ":https\\://www.biomedcentral.com/openurl/pdf?id=doi\\:10.1186/s13174-021-00140-z:PDF"
            )
            .withField(
                StandardField.ABSTRACT,
        ...
        BibEntry secondArticle = new BibEntry(StandardEntryType.Article)
            .withField(
                StandardField.AUTHOR,
                "Steinmacher, Igor and Gerosa, Marco and Conte, Tayana U. and Redmiles, David F."
            )
            ...
            .withField(
                StandardField.FILE,
                ":http\\://link.springer.com/openurl/pdf?id=doi\\:10.1007/s10606-018-9335-z:PDF"
            )
            .withField(
                StandardField.ABSTRACT,
        ...
        BibEntry thirdArticle = new BibEntry(StandardEntryType.InCollection)
            .withField(
                StandardField.AUTHOR,
                "Serrano Alves, Luiz Philipe and Wiese, Igor Scaliante and Chaves, Ana Paula and Steinmacher, Igor"
            )
            ...
            .withField(
                StandardField.FILE,
                ":http\\://link.springer.com/openurl/pdf?id=doi\\:10.1007/978-3-030-94890-0_6:PDF"
            )
        ...
        BibEntry fourthArticle = new BibEntry(StandardEntryType.Article)
            .withField(
                StandardField.AUTHOR,
                "Calefato, Fabio and Gerosa, Marco Aurélio and Iaffaldano, Giuseppe and Lanubile, Filippo and Steinmacher, Igor"
            )
            .withField(StandardField.DATE, "2022-03-19")
            .withField(StandardField.DOI, "10.1007/s10664-021-10012-6")
            .withField(
                StandardField.FILE,
                ":http\\://link.springer.com/openurl/pdf?id=doi\\:10.1007/s10664-021-10012-6:PDF"
            )
            .withField(StandardField.ISSN, "1382-3256")
            .withField(StandardField.JOURNAL, "Empirical Software Engineering")
    ...
    @Test
    @Disabled(
        "Year range search is not natively supported by the API, but can be emulated by multiple single year searches."
    )
    @Override
    ...
    public void supportsPhraseSearch() throws Exception {
        ...
        BibEntry expected = new BibEntry(StandardEntryType.InCollection)
            .withField(
                StandardField.AUTHOR,
                "Booth, Kayla M. and Dosono, Bryan and Redmiles, Elissa M. and Morales, Miraida and Depew, Michael and Farzan, Rosta and Herman, Everett and Trahan, Keith and Tananis, Cindy"
            )
            ...
            .withField(
                StandardField.FILE,
                ":http\\://link.springer.com/openurl/pdf?id=doi\\:10.1007/978-3-319-78105-1_75:PDF"
            )
            .withField(
                StandardField.ABSTRACT,
    ...
    public void supportsBooleanANDSearch() throws Exception {
        ...
        List<BibEntry> allEntriesFromCSCW = result
            .stream()
            .filter(bibEntry ->
                "Computer Supported Cooperative Work (CSCW)".equals(
                        bibEntry.getField(StandardField.JOURNAL).orElse("")
                    )
            )
            .toList();
        allEntriesFromCSCW
