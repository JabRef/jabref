...
class GoogleScholarTest implements SearchBasedFetcherCapabilityTest, PagedSearchFetcherTest {
    ...
    void findSingleEntry() throws FetcherException {
        ...
        List<BibEntry> foundEntries = finder.performComplexSearch("Detecting Interoperability and Correctness Issues in BPMN 2.0 Process Models");
    ...
    void findManyEntries() throws FetcherException {
        List<BibEntry> foundEntries = finder.performComplexSearch("random test string");
