...
class ScienceDirectTest {
    ...
    void findByDoiOldPage() throws IOException {
        ...
        assertEquals(
            Optional.of(
                new URL(
                    "https://www.sciencedirect.com/science/article/pii/S1674775515001079/pdfft?md5=2b19b19a387cffbae237ca6a987279df&pid=1-s2.0-S1674775515001079-main.pdf"
                )
            ),
    ...
    void findByDoiNewPage() throws IOException {
        ...
        assertEquals(
            Optional.of(
                new URL(
                    "https://www.sciencedirect.com/science/article/pii/S2212671614001024/pdf?md5=4e2e9a369b4d5b3db5100aba599bef8b&pid=1-s2.0-S2212671614001024-main.pdf"
                )
            ),
            finder.findFullText(entry)
        );
    ...
    void findByDoiWorksForBoneArticle() throws IOException {
        ...
        assertEquals(
            Optional.of(
                new URL(
                    "https://www.sciencedirect.com/science/article/pii/S8756328220300065/pdfft?md5=0ad75ff155637dec358e5c9fb8b90afd&pid=1-s2.0-S8756328220300065-main.pdf"
                )
            ),
            finder.findFullText(entry)
        );
