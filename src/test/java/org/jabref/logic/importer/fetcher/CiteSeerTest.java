...
class CiteSeerTest {
    ...
    void searchWithSortingByYear() throws FetcherException {
        ...
        List<BibEntry> fetchedEntries = fetcher.performSearch(
            "title:Theory AND year:1552 AND sortBy:Year"
        );
    ...
    void searchWithSortingByYearAndYearRange() throws FetcherException {
        List<BibEntry> fetchedEntries = fetcher.performSearch(
            "title:Theory AND year-range:2002-2012 AND sortBy:Year"
        );
        ...
        while (fetchedEntriesIter.hasNext()) {
            ...
            if (
                ...
                Integer laterYear = Integer.parseInt(
                    laterEntry.getField(StandardField.YEAR).orElse("0")
                );
