        ...
        bibEntryISBN9783960886402 =
            new BibEntry(StandardEntryType.Misc)
                ...
                .withField(
                    ...
                    "3. Auflage, Übersetzung der englischsprachigen 3. Originalausgabe 2018"
                )
                .withField(
                    StandardField.FILE,
                    "ParsedFileField{description='', link='http://search.ebscohost.com/login.aspx?direct=true&scope=site&db=nlebk&db=nlabk&AN=1906353', fileType='PDF'}"
                )
                ...
                .withField(
                    ...
                    "{dpunkt.verlag} and {Dpunkt. Verlag (Heidelberg)}"
                );

        bibEntryISBN0134685997 =
            new BibEntry(StandardEntryType.Misc)
                .withField(StandardField.TITLE, "Effective Java")
                .withField(StandardField.YEAR, "2018")
                .withField(StandardField.AUTHOR, "Bloch, Joshua")
