...
class IEEETest implements SearchBasedFetcherCapabilityTest, PagedSearchFetcherTest {
    ...
    void searchResultHasNoKeywordTerms() throws Exception {
        ...
        List<BibEntry> fetchedEntries = fetcher.performComplexSearch("8636659"); // article number
    ...
    void searchByQueryFindsEntry() throws Exception {
        ...
        List<BibEntry> fetchedEntries = fetcher.performComplexSearch("Overcoming Open Source Project Entry Barriers with a Portal for Newcomers");
        assertEquals(Collections.singletonList(expected), fetchedEntries);
    }
