...
public class NormalizeNamesFormatterTest {
    ...
    public void testNormalizeAuthorList() {
        ...
        assertEquals(
            "Bilbo, Staci D. and Smith, S. H. and Schwarz, Jaclyn M.",
            formatter.format("Staci D Bilbo and Smith SH and Jaclyn M Schwarz")
        );
        ...
        assertEquals(
            ...
            formatter.format(
                "Ølver MA; GG Øie; Øie GG; Alfredsen JÅÅ; Jo Alfredsen; Olsen Y.Y. and Olsen YY."
            )
        );
        ...
        assertEquals(
            "Ølver, M. A. and Øie, G. G. and Øie, G. G. and Alfredsen, J. Å. Å. and Alfredsen, Jo and Olsen, Y. Y. and Olsen, Y. Y.",
            formatter.format(
                "Ølver MA; GG Øie; Øie GG; Alfredsen JÅÅ; Jo Alfredsen; Olsen Y.Y.; Olsen YY."
            )
        );
        ...
        assertEquals(
            "Alver, M. A. and Alfredsen, J. A. and Olsen, Y. Y.",
            formatter.format("Alver, MA; Alfredsen, JA; Olsen Y.Y.")
        );
    ...
    public void twoAuthorsSeperatedByColon() {
        assertEquals(
            "Bilbo, Staci and Alver, Morten",
            formatter.format("Staci Bilbo; Morten Alver")
        );
    }
    ...
    public void threeAuthorsSeperatedByColon() {
        assertEquals(
            "Bilbo, Staci and Alver, Morten and Name, Test",
            formatter.format("Staci Bilbo; Morten Alver; Test Name")
        );
    }
    ...
    public void threeAuthorsSeperatedByAndWithDash() {
        assertEquals(
            ...
            formatter.format("Heng-Yu Jian and Xu, Z. and Chang, M.-C.F.")
        );
    }
    ...
    public void testOddCountOfCommas() {
        assertEquals(
            "Ali Babar, M., Dingsøyr T. Lago P.",
            formatter.format("Ali Babar, M., Dingsøyr, T., Lago P.")
        );
    }
    ...
    public void formatExample() {
        assertEquals(
            "Einstein, Albert and Turing, Alan",
    ...
    public void testNameAffixe() {
        assertEquals(
            "Surname, jr, First and Surname2, First2",
            formatter.format("Surname, jr, First, Surname2, First2")
        );
    }
    ...
    public void testAvoidSpecialCharacter() {
        assertEquals(
            "Surname, {, First; Surname2, First2",
            formatter.format("Surname, {, First; Surname2, First2")
        );
    }
    ...
    public void testAndInName() {
        assertEquals(
            "Surname and , First, Surname2 First2",
            formatter.format("Surname, and , First, Surname2, First2")
        );
    }
    ...
    public void testMultipleNameAffixes() {
        assertEquals(
            "Mair, Jr, Daniel and Brühl, Sr, Daniel",
            formatter.format("Mair, Jr, Daniel, Brühl, Sr, Daniel")
        );
    }
    ...
    public void testOneCommaUntouched() {
        assertEquals(
            "Canon der Barbar, Alexander der Große",
            formatter.format("Canon der Barbar, Alexander der Große")
        );
    }
    ...
    public void testUpperCaseSensitiveList() {
        assertEquals(
            "der Barbar, Canon and der Große, Alexander",
            formatter.format("Canon der Barbar AND Alexander der Große")
        );
        assertEquals(
            "der Barbar, Canon and der Große, Alexander",
            formatter.format("Canon der Barbar aNd Alexander der Große")
    ...
    public void testSemiCorrectNamesWithSemicolon() {
        assertEquals(
            ...
            formatter.format("Last, First; Last2, First2; Last3, First3")
        );
        assertEquals(
            "Last, Jr, First and Last2, First2",
            formatter.format("Last, Jr, First; Last2, First2")
        );
        assertEquals(
