...
public class FieldFormatterCleanupsTest {
    ...
    public void checkSimpleUseCase() {
        FieldFormatterCleanups actions = new FieldFormatterCleanups(
            true,
            FieldFormatterCleanups.parse("title[identity]")
        );

        FieldFormatterCleanup identityInTitle = new FieldFormatterCleanup(
            StandardField.TITLE,
            new IdentityFormatter()
        );
        assertEquals(
            Collections.singletonList(identityInTitle),
            actions.getConfiguredActions()
        );

        actions.applySaveActions(entry);

        assertEquals(
            Optional.of("Educational session 1"),
    ...
    public void invalidSaveActionSting() {
        FieldFormatterCleanups actions = new FieldFormatterCleanups(
            true,
            FieldFormatterCleanups.parse("title")
        );
    ...
    public void checkLowerCaseSaveAction() {
        FieldFormatterCleanups actions = new FieldFormatterCleanups(
            true,
            FieldFormatterCleanups.parse("title[lower_case]")
        );

        FieldFormatterCleanup lowerCaseTitle = new FieldFormatterCleanup(
            StandardField.TITLE,
            new LowerCaseFormatter()
        );
        assertEquals(
            Collections.singletonList(lowerCaseTitle),
            actions.getConfiguredActions()
        );
    ...
    public void checkTwoSaveActionsForOneField() {
        FieldFormatterCleanups actions = new FieldFormatterCleanups(
            true,
            FieldFormatterCleanups.parse("title[lower_case,identity]")
        );
        ...
        assertEquals(
            Arrays.asList(lowerCaseTitle, identityInTitle),
            actions.getConfiguredActions()
        );
    ...
    public void checkThreeSaveActionsForOneField() {
        FieldFormatterCleanups actions = new FieldFormatterCleanups(
            ...
            FieldFormatterCleanups.parse(
                "title[lower_case,identity,normalize_date]"
            )
        );
        ...
        FieldFormatterCleanup normalizeDatesInTitle = new FieldFormatterCleanup(
            StandardField.TITLE,
    ...
    public void checkMultipleSaveActions() {
        FieldFormatterCleanups actions = new FieldFormatterCleanups(
            true,
            FieldFormatterCleanups.parse(
                "pages[normalize_page_numbers]title[lower_case]"
            )
        );
        List<FieldFormatterCleanup> formatterCleanups =
            actions.getConfiguredActions();
        ...
        assertEquals(
            Arrays.asList(normalizePages, lowerCaseTitle),
            formatterCleanups
        );
    ...
    public void checkMultipleSaveActionsWithMultipleFormatters() {
        ...
        FieldFormatterCleanup normalizeDatesInPages = new FieldFormatterCleanup(
            StandardField.PAGES,
            new NormalizeDateFormatter()
        );
        FieldFormatterCleanup lowerCaseTitle = new FieldFormatterCleanup(
    ...
    public void clearFormatterRemovesField() {
        FieldFormatterCleanups actions = new FieldFormatterCleanups(
            true,
            FieldFormatterCleanups.parse("month[clear]")
        );
        actions.applySaveActions(entry);
    ...
    void formatterFromString() {
        assertEquals(
            ...
            FieldFormatterCleanups.getFormatterFromString(
                "replace_unicode_ligatures"
            )
        );
    }
}
