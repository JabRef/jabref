...
class BibEntryWriterTest {
    ...
    void roundTripTest() throws IOException {
        ...
        ParserResult result = new BibtexParser(preferencesService, fileMonitor).parse(new StringReader(bibtexEntry));
    ...
    void testEntryTypeChange() throws IOException {
        ...
        // read in bibtex string
        ParserResult result = new BibtexParser(preferencesService, fileMonitor).parse(new StringReader(expected));
        Collection<BibEntry> entries = result.getDatabase().getEntries();
        BibEntry entry = entries.iterator().next();
