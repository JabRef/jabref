...
public class FieldComparatorTest {
    ...
    public void compareMonthFieldBiggerDescending() throws Exception {
        FieldComparator comparator = new FieldComparator(
            new OrFields(StandardField.MONTH),
            true
        );
    ...
    public void compareYearFieldBiggerDescending() throws Exception {
        FieldComparator comparator = new FieldComparator(
            new OrFields(StandardField.YEAR),
            true
        );
    ...
    public void compareTypeFieldBiggerDescending() throws Exception {
        FieldComparator comparator = new FieldComparator(
            new OrFields(InternalField.TYPE_HEADER),
            true
        );
    ...
    public void compareNumericFieldsBiggerDescending() throws Exception {
        FieldComparator comparator = new FieldComparator(
            new OrFields(StandardField.PMID),
            true
        );
    ...
    @Test
    public void compareParsableWithNonParsableNumericFieldDescending()
        throws Exception {
        FieldComparator comparator = new FieldComparator(
            new OrFields(StandardField.PMID),
            true
    ...
    @ParameterizedTest
    @MethodSource
    public void compareNumericalValues(
        ...
        assertEquals(
            comparisonResult,
            comparator.compare(entry1, entry2),
            message
        );
    }
    ...
    private static Stream<Arguments> compareNumericalValues() {
        return Stream.of(
            Arguments.of(
                ...
                "123456",
                "123456",
                "IDs should be lexicographically equal"
            ),
            Arguments.of(
                1,
                "234567",
            ...
            Arguments.of(
                ...
                "",
                "",
                "Empty IDs should be lexicographically equal"
            ),
            Arguments.of(
                -1,
                "",
                "123456",
                "No ID should be lexicographically smaller than 123456"
            ),
            Arguments.of(
                1,
                "123456",
                "",
                "123456 should be lexicographically greater than no ID"
            )
        );
    }
