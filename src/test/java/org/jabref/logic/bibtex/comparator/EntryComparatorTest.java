...
class EntryComparatorTest {
    ...
    void recognizeIdenticalObjectsAsEqual() {
        ...
        assertEquals(
            0,
            new EntryComparator(false, false, StandardField.TITLE).compare(entry, entry)
        );
    }
    ...
    void compareObjectsByKeyAscending() {
        ...
        assertEquals(
            -1,
            new EntryComparator(false, false, InternalField.KEY_FIELD).compare(e2, e1)
        );
    }
    ...
    void compareWithMixedLineEndings() {
        ...
        assertEquals(
            -1,
            new EntryComparator(false, false, InternalField.KEY_FIELD).compare(e1, e2)
        );
    }
