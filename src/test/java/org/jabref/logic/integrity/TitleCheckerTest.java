...
public class TitleCheckerTest {
    ...
    class BibTexChecker {
        ...
        static Stream<Arguments> validTitle() {
            return Stream.of(
                Arguments.of(
                    "firstLetterAsOnlyCapitalLetterInSubTitle2 ",
                    "This is a sub title 1: This is a sub title 2"
                ),
                Arguments.of(
                    "noCapitalLetterInSubTitle2 ",
                    "This is a sub title 1: this is a sub title 2"
                ),
                Arguments.of(
                    "twoCapitalLettersInSubTitle2WithCurlyBrackets ",
                    "This is a sub title 1: This is {A} sub title 2"
                ),
                Arguments.of(
                    "middleLetterAsOnlyCapitalLetterInSubTitle2WithCurlyBrackets ",
                    "This is a sub title 1: this is {A} sub title 2"
                ),
                Arguments.of(
                ...
                Arguments.of(
                    "bibTexAcceptsOriginalAndTranslatedTitle ",
                    "This is a title [This is translated title]"
                )
            );
        }
        ...
        static Stream<Arguments> invalidTitle() {
            return Stream.of(
                Arguments.of(
                    "twoCapitalLettersInSubTitle2 ",
                    "This is a sub title 1: This is A sub title 2"
                ),
                Arguments.of(
                    "middleLetterAsOnlyCapitalLetterInSubTitle2 ",
                    "This is a sub title 1: this is A sub title 2"
                ),
                Arguments.of(
    ...
    class BibLaTexChecker {
        ...
        static Stream<Arguments> validTitle() {
            return Stream.of(
                ...
                Arguments.of(
                    "bibLaTexAcceptsSubTitlesWithOnlyFirstCapitalLetter",
                    "This is a sub title 1: This is a sub title 2"
                ),
                Arguments.of(
                    "bibLaTexAcceptsSubTitleWithLowercaseFirstLetter",
                    "This is a sub title 1: this is a sub title 2"
                ),
                Arguments.of(
                    "bibLaTexAcceptsCapitalLettersInsideSubTitle",
                    "This is a sub title 1: This is A sub title 2"
                ),
                Arguments.of(
                    "bibLaTexRemovesCapitalLetterInsideSubTitle",
                    "This is a sub title 1: this is {A} sub title 2"
                ),
                Arguments.of(
                    "bibLaTexSplitsSubTitlesBasedOnDots",
                    "This is a sub title 1...This is a sub title 2"
                ),
                Arguments.of(
                    "bibLaTexSplitsSubTitleBasedOnSpecialCharacters",
                    "This is; A sub title 1.... This is a sub title 2"
                ),
                Arguments.of(
                    "bibLaTexAcceptsCapitalLetterAfterSpecialCharacter",
                    "This!is!!A!Title??"
                ),
                Arguments.of(
                    "bibLaTexAcceptsCapitalLetterNotOnlyAfterSpecialCharacter",
                    "This!is!!A!TitlE??"
                )
            );
        }
