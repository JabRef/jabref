...
class URLDownloadTest {
    ...
    @Test
    void stringDownloadWithSetEncoding() throws IOException {
    ...
    @Test
    void stringDownload() throws IOException {
        URLDownload dl = new URLDownload(new URL("http://www.google.com"));
    ...
    @Test
    void determineMimeType() throws IOException {
        URLDownload dl = new URLDownload(new URL("http://www.google.com"));
    ...
    @Test
    void downloadToTemporaryFilePathWithoutFileSavesAsTmpFile() throws IOException {
    ...
    @Test
    void downloadToTemporaryFileKeepsName() throws IOException {
    ...
    void downloadOfFTPSucceeds() throws IOException {
    ...
    @Test
    void downloadOfHttpSucceeds() throws IOException {
    ...
    @Test
    void downloadOfHttpsSucceeds() throws IOException {
    ...
    @Test
    void test503ErrorThrowsNestedIOExceptionWithFetcherServerException() throws Exception {
    ...
    @Test
    void test429ErrorThrowsNestedIOExceptionWithFetcherServerException() throws Exception {
