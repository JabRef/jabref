...
class GroupNodeViewModelTest {
    ...
    void treeOfAutomaticKeywordGroupIsCombined() {
        ...
        WordKeywordGroup expectedGroupA = new WordKeywordGroup(
            "A",
        ...
        WordKeywordGroup expectedGroupE = new WordKeywordGroup(
            "E",
            GroupHierarchyType.INCLUDING,
            StandardField.KEYWORDS,
            "E",
    ...
    void draggedOnTopOfGroupAddsBeforeIt() {
        GroupNodeViewModel rootViewModel = getViewModelForGroup(
            new WordKeywordGroup(
                "root",
                GroupHierarchyType.INCLUDING,
                StandardField.KEYWORDS,
        ...
        WordKeywordGroup groupA = new WordKeywordGroup(
            "A",
            GroupHierarchyType.INCLUDING,
            StandardField.KEYWORDS,
            "A",
        ...
        GroupNodeViewModel groupAViewModel = getViewModelForGroup(
            rootViewModel.addSubgroup(groupA)
        );
        GroupNodeViewModel groupBViewModel = getViewModelForGroup(
            rootViewModel.addSubgroup(groupB)
        );
        GroupNodeViewModel groupCViewModel = getViewModelForGroup(
