...
class CopyCitationActionTest {
    ...
    void processPreviewText() throws Exception {
        ...
        ClipboardContent clipboardContent = CopyCitationAction.processPreview(
    ...
    void processText() throws Exception {
        ...
        String citation =
            "[1]B. Smith, B. Jones, and J. Williams, “Title of the test entry,” BibTeX Journal, vol. 34, no. 3, pp. 45–67, Jul. 2016." +
            OS.NEWLINE;
        ClipboardContent textTransferable = CopyCitationAction.processText(
            Arrays.asList(citation, citation)
        );
    ...
    void processHtmlAsHtml() throws Exception {
        ...
        String citation =
            ...
            "  </div>" +
            OS.NEWLINE;
        ClipboardContent htmlTransferable = CopyCitationAction.processHtml(
            Arrays.asList(citation, citation)
        );
