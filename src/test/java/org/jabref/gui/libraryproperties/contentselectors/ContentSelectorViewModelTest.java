...
public class ContentSelectorViewModelTest {
    ...
    void initHasDefaultFieldNames() {
        ListProperty<Field> expected = new SimpleListProperty<>(
            FXCollections.observableArrayList(DEFAULT_FIELDS)
        );
    ...
    void addsNewField() {
        ...
        boolean fieldsContainTestValue = fields
            .stream()
            .anyMatch(field -> "Test".equals(field.getDisplayName()));
    ...
    void savingPersistsDataInDatabase() {
        ...
        List<String> result = databaseContext
            .getMetaData()
