...
public class PersonNameStringConverterTest {
    ...
    @ParameterizedTest(
        name = "autoCompFF={0}, autoCompLF={1}, autoCompleteFirstNameMode={2}, expectedResult={3}"
    )
    @CsvSource(
        {
    ...
    void testToStringWithoutAutoCompletePreferences(
        boolean autoCompFF,
        boolean autoCompLF,
    ...
    @ParameterizedTest(
        name = "shouldAutoComplete={0}, firstNameMode={1}, nameFormat={2}, expectedResult={3}"
    )
    @CsvSource(
        {
    ...
    void testToStringWithAutoCompletePreferences(
