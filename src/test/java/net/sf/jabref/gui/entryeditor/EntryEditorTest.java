...
public class EntryEditorTest {
    ...
    public void changingAuthorUpdatesAutoCompleter() {
        ...
        EntryEditor editor = new EntryEditor(JabRefGUI.mainFrame, JabRefGUI.mainFrame.getCurrentBasePanel(), bibEntry);
        ...
        AutoCompleter<String> autoCompleter = JabRefGUI.mainFrame.getCurrentBasePanel().getAutoCompleters().get("author");
    ...
    public void changingSomeFieldUpdatesAutoCompleter() {
        ...
        // test content of stored words in autocompleter ...
        AutoCompleter<String> autoCompleter = JabRefGUI.mainFrame.getCurrentBasePanel().getAutoCompleters().get("journal");
