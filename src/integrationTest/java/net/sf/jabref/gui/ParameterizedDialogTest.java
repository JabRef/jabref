...
public class ParameterizedDialogTest extends AbstractUITest {
    ...
    public static Collection<Object[]> instancesToTest() {
        ...
        return Arrays.asList(
                ...
                new Object[]{true, new String[]{"File", "Connect to external SQL database"}, "Connect to SQL database", "Cancel", false},
                new Object[]{true, new String[]{"File", "Connect to external SQL database"}, "Connect to SQL database", "Close button", true},
                //new Object[]{false, new String[]{"File", "Import from external SQL database"}, "Connect to SQL database", "Cancel", false},
                //new Object[]{false, new String[]{"File", "Import from external SQL database"}, "Connect to SQL database", "Close button", true},
                new Object[]{true, new String[]{"File", "Export to external SQL database"}, "Connect to SQL database", "Cancel", false},
                new Object[]{true, new String[]{"File", "Export to external SQL database"}, "Connect to SQL database", "Close button", true},
